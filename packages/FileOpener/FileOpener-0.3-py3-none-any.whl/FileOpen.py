...
'''
This is a package that is meant to take in an excel file, and transform it into a dataframe

The key function is called import_file("path to file") and it returns a dictionary of pandas dataframes extracted from input excel or csv file
