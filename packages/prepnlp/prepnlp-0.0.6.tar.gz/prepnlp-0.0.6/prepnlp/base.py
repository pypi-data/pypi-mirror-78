class AspectTerm(object):
    ...
    def __str__(self) -> str:
        return 'AspectTerm(term={}, bio={}, sentiment={}, offset_start={}, offset_end={})'.format(
            self.term, self.bio, self.sentiment, self.offset_start, self.offset_end
        )
...
class AbsaDoc(object):
    ...
    def __str__(self) -> str:
        return 'AbsaDoc(doc_id={}\n, text={}\n, aspect_terms={}\n, aspect_category={})'.format(
            self.doc_id, self.text, self.aspect_terms, self.aspect_category
        )
