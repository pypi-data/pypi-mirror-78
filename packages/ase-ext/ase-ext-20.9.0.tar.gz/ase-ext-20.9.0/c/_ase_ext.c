...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 17), // void()(long *, double *, double *, double *, double *, int, int, int, int, int, int, int, int)
/*  1 */ _CFFI_OP(_CFFI_OP_POINTER, 16), // long *
/*  2 */ _CFFI_OP(_CFFI_OP_POINTER, 15), // double *
...
/* 16 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 9), // long
/* 17 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 0), // void
};

static void _cffi_d_lti_dos(long * x0, double * x1, double * x2, double * x3, double * x4, int x5, int x6, int x7, int x8, int x9, int x10, int x11, int x12)
{
  lti_dos(x0, x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_lti_dos(PyObject *self, PyObject *args)
{
  long * x0;
  double * x1;
  double * x2;
  ...
  if (!PyArg_UnpackTuple(args, "lti_dos", 13, 13, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, &arg6, &arg7, &arg8, &arg9, &arg10, &arg11, &arg12))
    return NULL;
...
#else
#  define _cffi_f_lti_dos _cffi_d_lti_dos
#endif

static const struct _cffi_global_s _cffi_globals[] = {
  { "lti_dos", (void *)_cffi_f_lti_dos, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_lti_dos },
};
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__ase_ext(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit__ase_ext(void) { return NULL; }
#  else
     init_ase_ext(void) { }
#  endif
#  endif
...
PyMODINIT_FUNC
PyInit__ase_ext(void)
{
  return _cffi_init("_ase_ext", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_ase_ext(void)
{
  _cffi_init("_ase_ext", 0x2601, &_cffi_type_context);
}
#endif
