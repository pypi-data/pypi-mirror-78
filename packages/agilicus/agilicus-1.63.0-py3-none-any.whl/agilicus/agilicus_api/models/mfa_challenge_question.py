...
class MFAChallengeQuestion(object):
    ...
    def __init__(self, user_preference='organisation_policy', client_id=None, org_id=None, user_id=None, upstream_idp=None, ip_address=None, amr_claim_present=False, local_vars_configuration=None):  # noqa: E501
