...
"""
    ...
    The version of the OpenAPI document: 2020.09.02
...
class MFAChallengeQuestion(object):
    ...
    def user_preference(self):
        """Gets the user_preference of this MFAChallengeQuestion.  # noqa: E501

        The user's preference regarding multi-factor authentication  # noqa: E501

        :return: The user_preference of this MFAChallengeQuestion.  # noqa: E501
        :rtype: str
        """
    ...
    def user_preference(self, user_preference):
        """Sets the user_preference of this MFAChallengeQuestion.

        The user's preference regarding multi-factor authentication  # noqa: E501

        :param user_preference: The user_preference of this MFAChallengeQuestion.  # noqa: E501
        :type: str
        """
    ...
    @property
    def client_id(self):
        """Gets the client_id of this MFAChallengeQuestion.  # noqa: E501

        the client initiating the request on behalf of the user  # noqa: E501

        :return: The client_id of this MFAChallengeQuestion.  # noqa: E501
        :rtype: str
        """
    ...
    def client_id(self, client_id):
        """Sets the client_id of this MFAChallengeQuestion.

        the client initiating the request on behalf of the user  # noqa: E501

        :param client_id: The client_id of this MFAChallengeQuestion.  # noqa: E501
        :type: str
        """
    ...
    def issuer_org_id(self):
        """Gets the issuer_org_id of this MFAChallengeQuestion.  # noqa: E501

        The id of the organisation for the issuer the user is logging in through  # noqa: E501

        :return: The issuer_org_id of this MFAChallengeQuestion.  # noqa: E501
        :rtype: str
        """
    ...
    def issuer_org_id(self, issuer_org_id):
        """Sets the issuer_org_id of this MFAChallengeQuestion.

        The id of the organisation for the issuer the user is logging in through  # noqa: E501

        :param issuer_org_id: The issuer_org_id of this MFAChallengeQuestion.  # noqa: E501
        :type: str
        """
    ...
    @property
    def org_id(self):
        """Gets the org_id of this MFAChallengeQuestion.  # noqa: E501

        The id of the organisation the user is a member of  # noqa: E501

        :return: The org_id of this MFAChallengeQuestion.  # noqa: E501
        :rtype: str
        """
        return self._org_id
    ...
    def org_id(self, org_id):
        """Sets the org_id of this MFAChallengeQuestion.

        The id of the organisation the user is a member of  # noqa: E501

        :param org_id: The org_id of this MFAChallengeQuestion.  # noqa: E501
        :type: str
        """
    ...
    @property
    def user_id(self):
        """Gets the user_id of this MFAChallengeQuestion.  # noqa: E501

        The id of the user requesting access  # noqa: E501

        :return: The user_id of this MFAChallengeQuestion.  # noqa: E501
        :rtype: str
        """
    ...
    def user_id(self, user_id):
        """Sets the user_id of this MFAChallengeQuestion.

        The id of the user requesting access  # noqa: E501

        :param user_id: The user_id of this MFAChallengeQuestion.  # noqa: E501
        :type: str
        """
    ...
    def upstream_idp(self):
        """Gets the upstream_idp of this MFAChallengeQuestion.  # noqa: E501

        The upstream IDP that the user is authenticating against  # noqa: E501

        :return: The upstream_idp of this MFAChallengeQuestion.  # noqa: E501
        :rtype: str
        """
    ...
    def upstream_idp(self, upstream_idp):
        """Sets the upstream_idp of this MFAChallengeQuestion.

        The upstream IDP that the user is authenticating against  # noqa: E501

        :param upstream_idp: The upstream_idp of this MFAChallengeQuestion.  # noqa: E501
        :type: str
        """
    ...
    @property
    def ip_address(self):
        """Gets the ip_address of this MFAChallengeQuestion.  # noqa: E501

        The source ip address of the user's request. Both IPv4 and IPv6 address are supported  # noqa: E501

        :return: The ip_address of this MFAChallengeQuestion.  # noqa: E501
        :rtype: str
        """
    ...
    def ip_address(self, ip_address):
        """Sets the ip_address of this MFAChallengeQuestion.

        The source ip address of the user's request. Both IPv4 and IPv6 address are supported  # noqa: E501

        :param ip_address: The ip_address of this MFAChallengeQuestion.  # noqa: E501
        :type: str
        """
    ...
    def amr_claim_present(self):
        """Gets the amr_claim_present of this MFAChallengeQuestion.  # noqa: E501

        Whether the amr claim is present in the response from the upstream  # noqa: E501

        :return: The amr_claim_present of this MFAChallengeQuestion.  # noqa: E501
        :rtype: bool
        """
    ...
    def amr_claim_present(self, amr_claim_present):
        """Sets the amr_claim_present of this MFAChallengeQuestion.

        Whether the amr claim is present in the response from the upstream  # noqa: E501

        :param amr_claim_present: The amr_claim_present of this MFAChallengeQuestion.  # noqa: E501
        :type: bool
        """
