...
class MFAEnrollmentQuestion(object):
    ...
    def issuer_org_id(self):
        """Gets the issuer_org_id of this MFAEnrollmentQuestion.  # noqa: E501

        The id of the organisation for the issuer the user is logging in through. This determines what policy to query  # noqa: E501

        :return: The issuer_org_id of this MFAEnrollmentQuestion.  # noqa: E501
        :rtype: str
        """
    ...
    def issuer_org_id(self, issuer_org_id):
        """Sets the issuer_org_id of this MFAEnrollmentQuestion.

        The id of the organisation for the issuer the user is logging in through. This determines what policy to query  # noqa: E501

        :param issuer_org_id: The issuer_org_id of this MFAEnrollmentQuestion.  # noqa: E501
        :type: str
        """
