...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'spotinst', '2.10.0-alpha.1598894770+a9d762f7'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource spotinst 2.10.0-alpha.1598894770+a9d762f7`
                """)
            else:
                raise
