...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'spotinst', '2.11.0-alpha.1599152554+09d0cebe'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource spotinst 2.11.0-alpha.1599152554+09d0cebe`
                """)
            else:
                raise
