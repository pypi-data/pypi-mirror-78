...
setup(
    ...
    description="State-of-the-art Natural Language Processing for TensorFlow 2.0 and PyTorch. Note that the tokenizer was changed by PhoBert in this version.",
