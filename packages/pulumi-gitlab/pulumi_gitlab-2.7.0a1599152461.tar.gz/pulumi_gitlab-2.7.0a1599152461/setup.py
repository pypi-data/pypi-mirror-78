...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gitlab', '2.7.0-alpha.1599152461+82b75155'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gitlab 2.7.0-alpha.1599152461+82b75155`
                """)
            else:
                raise
