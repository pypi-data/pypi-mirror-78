...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'f5bigip', '2.4.0-alpha.1598734857+b9fb06c2'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource f5bigip 2.4.0-alpha.1598734857+b9fb06c2`
                """)
            else:
                raise
