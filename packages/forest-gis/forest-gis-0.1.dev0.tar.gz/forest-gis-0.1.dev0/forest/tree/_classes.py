...
class BaseDecisionTree(MultiOutputMixin, BaseEstimator, metaclass=ABCMeta):
    ...
    def local_variable_importance_g(self, X, y, grouping, subs_num, check_input = True):
        X = np.array(X)
        y = np.array(y).ravel()
        X = self._validate_X_predict(X, check_input)
        ...
        if X.shape[0] != grouping.shape[1]:
            raise ValueError('The input X has different number of instances with grouping variable')
        return (np.array(self.tree_.local_variable_importance_g(X, y, grouping, subs_num))[None,:,:])
# =============================================================================
# Public estimators
# =============================================================================
