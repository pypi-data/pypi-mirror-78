...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'wavefront', '0.1.1-alpha.1598913806+5c4b53c7'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource wavefront 0.1.1-alpha.1598913806+5c4b53c7`
                """)
            else:
                raise
