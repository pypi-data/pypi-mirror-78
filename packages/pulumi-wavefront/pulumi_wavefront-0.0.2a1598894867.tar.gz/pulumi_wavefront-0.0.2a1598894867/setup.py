...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'wavefront', '0.0.2-alpha.1598894867+d23c3e64'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource wavefront 0.0.2-alpha.1598894867+d23c3e64`
                """)
            else:
                raise
