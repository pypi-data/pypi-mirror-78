    ...
    """
{
    ...
    "package_data": {
        "cloudcomponents.cdk_codepipeline_slack._jsii": [
            "cdk-codepipeline-slack@1.0.83.jsii.tgz"
        ],
        "cloudcomponents.cdk_codepipeline_slack": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-codepipeline-actions>=1.62.0, <2.0.0",
        "aws-cdk.aws-codepipeline>=1.62.0, <2.0.0",
        "aws-cdk.aws-events-targets>=1.62.0, <2.0.0",
        "aws-cdk.aws-events>=1.62.0, <2.0.0",
        "aws-cdk.aws-iam>=1.62.0, <2.0.0",
        "aws-cdk.aws-lambda>=1.62.0, <2.0.0",
        "aws-cdk.aws-s3>=1.62.0, <2.0.0",
        "aws-cdk.aws-sns-subscriptions>=1.62.0, <2.0.0",
