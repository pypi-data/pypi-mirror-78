...
"""equpartflip - DHF All Equity Partnership Flip Financial Model_"""
...
class Data(ssc.DataDict):
    ...
    reserves_interest: float = INPUT(label='Interest on reserves', units='%', type='NUMBER', group='Reserve Accounts', required='?=1.75', constraints='MIN=0,MAX=100')
    ...
    equip_reserve_depr_sta: float = INPUT(label='Major equipment reserve state depreciation', type='NUMBER', group='Depreciation', required='?=0', constraints='INTEGER,MIN=0,MAX=6', meta='0=5yr MACRS,1=15yr MACRS,2=5yr SL,3=15yr SL, 4=20yr SL,5=39yr SL,6=Custom')
    equip_reserve_depr_fed: float = INPUT(label='Major equipment reserve federal depreciation', type='NUMBER', group='Depreciation', required='?=0', constraints='INTEGER,MIN=0,MAX=6', meta='0=5yr MACRS,1=15yr MACRS,2=5yr SL,3=15yr SL, 4=20yr SL,5=39yr SL,6=Custom')
    salvage_percentage: float = INPUT(label='Net pre-tax cash salvage value', units='%', type='NUMBER', group='Salvage Value', required='?=10', constraints='MIN=0,MAX=100')
    ppa_soln_mode: float = INPUT(label='PPA solution mode', units='0/1', type='NUMBER', group='Solution Mode', required='?=0', constraints='INTEGER,MIN=0,MAX=1', meta='0=solve ppa,1=specify ppa')
    ppa_soln_tolerance: float = INPUT(label='PPA solution tolerance', type='NUMBER', group='Solution Mode', required='?=1e-3')
    ppa_soln_min: float = INPUT(label='PPA solution minimum ppa', units='cents/kWh', type='NUMBER', group='Solution Mode', required='?=0')
    ppa_soln_max: float = INPUT(label='PPA solution maximum ppa', units='cents/kWh', type='NUMBER', group='Solution Mode', required='?=100')
    ppa_soln_max_iterations: float = INPUT(label='PPA solution maximum number of iterations', type='NUMBER', group='Solution Mode', required='?=100', constraints='INTEGER,MIN=1')
    ppa_price_input: float = INPUT(label='Initial year PPA price', units='$/kWh', type='NUMBER', group='Solution Mode', required='?=10')
    ppa_escalation: float = INPUT(label='PPA escalation', units='%', type='NUMBER', group='Solution Mode', required='?=0')
    ...
    tax_investor_equity_percent: float = INPUT(label='Tax investor equity', units='%', type='NUMBER', group='IRR Targets', required='?=98', constraints='MIN=0,MAX=100')
    tax_investor_preflip_cash_percent: float = INPUT(label='Tax investor pre-flip cash ', units='%', type='NUMBER', group='IRR Targets', required='?=98', constraints='MIN=0,MAX=100')
    tax_investor_postflip_cash_percent: float = INPUT(label='Tax investor post-flip cash ', units='%', type='NUMBER', group='IRR Targets', required='?=15', constraints='MIN=0,MAX=100')
    tax_investor_preflip_tax_percent: float = INPUT(label='Tax investor pre-flip tax benefit ', units='%', type='NUMBER', group='IRR Targets', required='?=98', constraints='MIN=0,MAX=100')
    tax_investor_postflip_tax_percent: float = INPUT(label='Tax investor post-flip tax benefit ', units='%', type='NUMBER', group='IRR Targets', required='?=15', constraints='MIN=0,MAX=100')
    flip_target_percent: float = INPUT(label='After-tax flip/return target', units='%', type='NUMBER', group='IRR Targets', required='?=11', constraints='MIN=0,MAX=100')
    flip_target_year: float = INPUT(label='Return target year', type='NUMBER', group='IRR Targets', required='?=11', constraints='MIN=1')
    ...
    cf_project_return_aftertax_cash: Final[Array] = OUTPUT(label='Project after-tax operating cash', units='$', type='ARRAY', group='Cash Flow After Tax Returns', required='*', constraints='LENGTH_EQUAL=cf_length')
    ...
    cbi_total_fed: Final[float] = OUTPUT(label='Federal CBI income', units='$', type='NUMBER', group='Cash Flow Cash Incentives', required='*')
    cbi_total_sta: Final[float] = OUTPUT(label='State CBI income', units='$', type='NUMBER', group='Cash Flow Cash Incentives', required='*')
    cbi_total_oth: Final[float] = OUTPUT(label='Other CBI income', units='$', type='NUMBER', group='Cash Flow Cash Incentives', required='*')
    cbi_total_uti: Final[float] = OUTPUT(label='Utility CBI income', units='$', type='NUMBER', group='Cash Flow Cash Incentives', required='*')
    cbi_total: Final[float] = OUTPUT(label='Total CBI income', units='$', type='NUMBER', group='Cash Flow Cash Incentives', required='*')
    cbi_statax_total: Final[float] = OUTPUT(label='State taxable CBI income', units='$', type='NUMBER', group='Cash Flow Cash Incentives', required='*')
    cbi_fedtax_total: Final[float] = OUTPUT(label='Federal taxable CBI income', units='$', type='NUMBER', group='Cash Flow Cash Incentives', required='*')
    ibi_total_fed: Final[float] = OUTPUT(label='Federal IBI income', units='$', type='NUMBER', group='Cash Flow Cash Incentives', required='*')
    ibi_total_sta: Final[float] = OUTPUT(label='State IBI income', units='$', type='NUMBER', group='Cash Flow Cash Incentives', required='*')
    ibi_total_oth: Final[float] = OUTPUT(label='Other IBI income', units='$', type='NUMBER', group='Cash Flow Cash Incentives', required='*')
    ibi_total_uti: Final[float] = OUTPUT(label='Utility IBI income', units='$', type='NUMBER', group='Cash Flow Cash Incentives', required='*')
    ibi_total: Final[float] = OUTPUT(label='Total IBI income', units='$', type='NUMBER', group='Cash Flow Cash Incentives', required='*')
    ibi_statax_total: Final[float] = OUTPUT(label='State taxable IBI income', units='$', type='NUMBER', group='Cash Flow Cash Incentives', required='*')
    ibi_fedtax_total: Final[float] = OUTPUT(label='Federal taxable IBI income', units='$', type='NUMBER', group='Cash Flow Cash Incentives', required='*')
    itc_total_fed: Final[float] = OUTPUT(label='Federal ITC income', units='$', type='NUMBER', group='Cash Flow Cash Incentives', required='*')
    itc_total_sta: Final[float] = OUTPUT(label='State ITC income', units='$', type='NUMBER', group='Cash Flow Cash Incentives', required='*')
    itc_total: Final[float] = OUTPUT(label='Total ITC income', units='$', type='NUMBER', group='Cash Flow Cash Incentives', required='*')
    cf_pbi_total_fed: Final[Array] = OUTPUT(label='Federal PBI income', units='$', type='ARRAY', group='Cash Flow Cash Incentives', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_pbi_total_sta: Final[Array] = OUTPUT(label='State PBI income', units='$', type='ARRAY', group='Cash Flow Cash Incentives', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_pbi_total_oth: Final[Array] = OUTPUT(label='Other PBI income', units='$', type='ARRAY', group='Cash Flow Cash Incentives', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_pbi_total_uti: Final[Array] = OUTPUT(label='Utility PBI income', units='$', type='ARRAY', group='Cash Flow Cash Incentives', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_pbi_total: Final[Array] = OUTPUT(label='Total PBI income', units='$', type='ARRAY', group='Cash Flow Cash Incentives', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_pbi_statax_total: Final[Array] = OUTPUT(label='State taxable PBI income', units='$', type='ARRAY', group='Cash Flow Cash Incentives', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_pbi_fedtax_total: Final[Array] = OUTPUT(label='Federal taxable PBI income', units='$', type='ARRAY', group='Cash Flow Cash Incentives', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_ptc_fed: Final[Array] = OUTPUT(label='Federal PTC income', units='$', type='ARRAY', group='Cash Flow Tax Credits', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_ptc_sta: Final[Array] = OUTPUT(label='State PTC income', units='$', type='ARRAY', group='Cash Flow Tax Credits', required='*', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_stadepr_total: Final[Array] = OUTPUT(label='State tax depreciation', units='$', type='ARRAY', group='Cash Flow State Income Tax', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_statax_income_prior_incentives: Final[Array] = OUTPUT(label='State tax income prior incentives', units='$', type='ARRAY', group='Cash Flow State Income Tax', required='*', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_statax_income_with_incentives: Final[Array] = OUTPUT(label='State tax income with incentives', units='$', type='ARRAY', group='Cash Flow State Income Tax', required='*', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_feddepr_total: Final[Array] = OUTPUT(label='Federal tax depreciation', units='$', type='ARRAY', group='Cash Flow Federal Income Tax', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_fedtax_income_prior_incentives: Final[Array] = OUTPUT(label='Federal tax income prior incentives', units='$', type='ARRAY', group='Cash Flow Federal Income Tax', required='*', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_fedtax_income_with_incentives: Final[Array] = OUTPUT(label='Federal tax income with incentives', units='$', type='ARRAY', group='Cash Flow Federal Income Tax', required='*', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_tax_investor_pretax: Final[Array] = OUTPUT(label='Tax investor pre-tax returns', units='$', type='ARRAY', group='Cash Flow Tax Investor Returns', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_tax_investor_pretax_irr: Final[Array] = OUTPUT(label='Tax investor pre-tax cumulative IRR', units='%', type='ARRAY', group='Cash Flow Tax Investor Returns', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_tax_investor_pretax_npv: Final[Array] = OUTPUT(label='Tax investor pre-tax cumulative NPV', units='$', type='ARRAY', group='Cash Flow Tax Investor Returns', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_tax_investor_aftertax_cash: Final[Array] = OUTPUT(label='Tax investor after-tax cash returns', units='$', type='ARRAY', group='Cash Flow Tax Investor Returns', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_tax_investor_aftertax_itc: Final[Array] = OUTPUT(label='Tax investor share of ITC', units='$', type='ARRAY', group='Cash Flow Tax Investor Returns', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_tax_investor_aftertax_ptc: Final[Array] = OUTPUT(label='Tax investor share of PTC', units='$', type='ARRAY', group='Cash Flow Tax Investor Returns', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_tax_investor_aftertax_tax: Final[Array] = OUTPUT(label='Tax investor shaer of tax benefit/(liability)', units='$', type='ARRAY', group='Cash Flow Tax Investor Returns', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_tax_investor_aftertax: Final[Array] = OUTPUT(label='Tax investor after-tax returns', units='$', type='ARRAY', group='Cash Flow Tax Investor Returns', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_tax_investor_aftertax_irr: Final[Array] = OUTPUT(label='Tax investor after-tax cumulative IRR', units='%', type='ARRAY', group='Cash Flow Tax Investor Returns', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_tax_investor_aftertax_npv: Final[Array] = OUTPUT(label='Tax investor after-tax cumulative NPV', units='$', type='ARRAY', group='Cash Flow Tax Investor Returns', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_tax_investor_aftertax_max_irr: Final[Array] = OUTPUT(label='Tax investor after-tax maximum IRR', units='%', type='ARRAY', group='Cash Flow Tax Investor Returns', required='*', constraints='LENGTH_EQUAL=cf_length')
    tax_investor_aftertax_irr: Final[float] = OUTPUT(label='Tax investor after-tax IRR', type='NUMBER', group='Cash Flow Tax Investor Returns', required='*')
    tax_investor_aftertax_npv: Final[float] = OUTPUT(label='Tax investor after-tax NPV', type='NUMBER', group='Cash Flow Tax Investor Returns', required='*')
    tax_investor_pretax_irr: Final[float] = OUTPUT(label='Tax investor pre-tax IRR', units='%', type='NUMBER', group='Cash Flow Tax Investor Returns', required='*')
    tax_investor_pretax_npv: Final[float] = OUTPUT(label='Tax investor pre-tax NPV', units='$', type='NUMBER', group='Cash Flow Tax Investor Returns', required='*')
    ...
    cf_sponsor_pretax_cash_post_recovery: Final[Array] = OUTPUT(label='Developer pre-tax cash post recovery', units='$', type='ARRAY', group='Cash Flow Developer Returns', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_sponsor_pretax_cash_during_recovery: Final[Array] = OUTPUT(label='Developer pre-tax cash during recovery', units='$', type='ARRAY', group='Cash Flow Developer Returns', required='*', constraints='LENGTH_EQUAL=cf_length')
    ...
    sponsor_pretax_irr: Final[float] = OUTPUT(label='Developer pre-tax IRR', units='%', type='NUMBER', group='Cash Flow Developer Returns', required='*')
    ...
    sponsor_aftertax_irr: Final[float] = OUTPUT(label='Developer after-tax IRR', units='%', type='NUMBER', group='Cash Flow Developer Returns', required='*')
    ...
    flip_actual_year: Final[float] = OUTPUT(label='IRR actual year', units='%', type='NUMBER', group='Metrics', required='*')
    ...
    ppa: Final[float] = OUTPUT(label='PPA price', units='cents/kWh', type='NUMBER', group='Metrics', required='*')
    npv_ppa_revenue: Final[float] = OUTPUT(label='NPV of PPA revenue', units='$', type='NUMBER', group='Metrics', required='*')
    npv_energy_nom: Final[float] = OUTPUT(label='NPV of net annual energy (nominal)', units='kWh', type='NUMBER', group='Metrics', required='*')
    npv_energy_real: Final[float] = OUTPUT(label='NPV of net annual energy (real)', units='kWh', type='NUMBER', group='Metrics', required='*')
    present_value_oandm: Final[float] = OUTPUT(label='Present value of O and M', units='$', type='NUMBER', group='Metrics', required='*')
    present_value_oandm_nonfuel: Final[float] = OUTPUT(label='Present value of non-fuel O and M', units='$', type='NUMBER', group='Metrics', required='*')
    present_value_fuel: Final[float] = OUTPUT(label='Present value of fuel O and M', units='$', type='NUMBER', group='Metrics', required='*')
    ...
    lcoptc_fed_real: Final[float] = OUTPUT(label='Levelized federal PTC (real)', units='$', type='NUMBER', group='Metrics', required='*')
    lcoptc_fed_nom: Final[float] = OUTPUT(label='Levelized federal PTC (nominal)', units='$', type='NUMBER', group='Metrics', required='*')
    lcoptc_sta_real: Final[float] = OUTPUT(label='Levelized state PTC (real)', units='$', type='NUMBER', group='Metrics', required='*')
    lcoptc_sta_nom: Final[float] = OUTPUT(label='Levelized state PTC (nominal)', units='$', type='NUMBER', group='Metrics', required='*')
    wacc: Final[float] = OUTPUT(label='Weighted average cost of capital (WACC)', type='NUMBER', group='Metrics', required='*')
    effective_tax_rate: Final[float] = OUTPUT(label='Effective tax rate', type='NUMBER', group='Metrics', required='*')
    analysis_period_irr: Final[float] = OUTPUT(label='Analysis period IRR', type='NUMBER', group='Metrics', required='*')
