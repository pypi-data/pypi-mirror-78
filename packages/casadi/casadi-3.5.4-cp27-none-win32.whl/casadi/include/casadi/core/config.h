...
#define CASADI_VERSION_STRING "3.5.4"
#define CASADI_GIT_REVISION "1291fe3fb6866c7e1e5e45bca8d9d92afbd9d995"  // NOLINT(whitespace/line_length)
#define CASADI_GIT_DESCRIBE "3.3.0-306.1291fe3fb"  // NOLINT(whitespace/line_length)
