...
from besos.types import PathLike
...
class VariableReader(EPReader):
    ...
    def __init__(
        ...
        :param key_value: What to measure (e.g. Electricity:Facility)
        :param variable_name:  The kind of variable to use (e.g. Output:Variable)
        :param class_name: the type of variable to read from.
