...
class Problem(IO_Objects.ReprMixin):
    ...
    def __init__(
        ...
        *,
        ...
        :param constraint_bounds: A list of strings that are parsable by platypus, and which represent bounds
            on the corresponding constraints.
        :param minimize_outputs: A list of booleans indicating if the corresponding output should be
            minimized or maximized. (Default is to minimize all outputs).
