...
def validate(pkg_name: str = None, sermos_yaml_filename: str = None,
    ...
    sd = SermosDeploy(
        access_key='fake', pkg_name=pkg_name,
...
def deploy(access_key: str = None, pkg_name: str = None,
    ...
    # Instantiate SermosDeploy
    sd = SermosDeploy(
        access_key=access_key, pkg_name=pkg_name,
...
def status(access_key: str = None, deploy_url: str = None):
    ...
    # Instantiate SermosDeploy
    sd = SermosDeploy(
        access_key=access_key, deploy_url=deploy_url
    )
