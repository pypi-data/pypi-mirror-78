...
class ModelResource(WaylayResource):
    ...
    actions = {
        'list': {
            'method': 'GET', 'url': '/models', 'decorators': [
                byoml_exception_decorator,
        ...
        '_replace': {
            'method': 'PUT', 'url': '/models/{}',
            'decorators': DEFAULT_DECORATORS},
        'get': {
            'method': 'GET', 'url': '/models/{}',
            'decorators': DEFAULT_DECORATORS},
        'examples': {
            'method': 'GET', 'url': '/models/{}/examples',
            'decorators': [
                byoml_exception_decorator,
                return_path_decorator(['example_payloads'])
            ]},
        'predict': {
            'method': 'POST', 'url': '/models/{}/predict',
            'decorators': _execute_model_decorators('predictions')},
        'regress': {
            'method': 'POST', 'url': '/models/{}/regress',
            'decorators': _execute_model_decorators('result')},
        'classify': {
            'method': 'POST', 'url': '/models/{}/classify',
            'decorators': _execute_model_decorators('result')},
        'remove': {
            'method': 'DELETE', 'url': '/models/{}',
            'decorators': DEFAULT_DECORATORS},
    }
