...
from flowty.interop import ffi, libFlowty
...
class LinExpr:
    ...
    def __init__(
        ...
        libFlowty.FLWT_LinExpr_new(self.__linExpr)
    ...
    def __del__(self):
        libFlowty.FLWT_LinExpr_delete(self.__linExpr)
    ...
    def addConstant(self, constant: float) -> None:
        ...
        """
        libFlowty.FLWT_LinExpr_addConstant(self.__linExpr, constant)
    ...
    def addTerm(self, coef: float, var: "Var") -> None:
        ...
        Parameters:
            ...
            var: The variable.
        """
        libFlowty.FLWT_LinExpr_addTerm(self.__linExpr, coef, var._Var__var)

    @property
    def constant(self) -> float:
        """The constant term."""
        constant = ffi.new("double *")
        libFlowty.FLWT_LinExpr_getConstant(self.__linExpr, constant)
        return constant[0]
    ...
    def coefs(self) -> List[float]:
        ...
        num = ffi.new("int *")
        libFlowty.FLWT_LinExpr_getNumTerms(self.__linExpr, num)
        num = num[0]
        array = ffi.new("double []", num)
        libFlowty.FLWT_LinExpr_getCoefs(self.__linExpr, array)
    ...
    def vars(self) -> List["Var"]:
        ...
        libFlowty.FLWT_LinExpr_getVars(self.__linExpr, array)
...
class LinEqua(LinExpr):
    ...
    def __init__(
        ...
        if isinstance(expr, LinEqua):
            libFlowty.FLWT_LinEqua_copy(self.__linEqua, expr._LinEqua__linEqua)
        else:
    ...
    def __del__(self):
        libFlowty.FLWT_LinEqua_delete(self.__linEqua)
...
class Var:
    ...
    def lb(self) -> float:
        ...
        libFlowty.FLWT_Var_getLb(self.__var, value)
        return value[0]

    @lb.setter
    def lb(self, value: float):
        libFlowty.FLWT_Var_setLb(self.__var, value)

    @property
    def ub(self) -> float:
        """The upper bound."""
        value = ffi.new("double *")
        libFlowty.FLWT_Var_getUb(self.__var, value)
        return value[0]

    @ub.setter
    def ub(self, value: float):
        libFlowty.FLWT_Var_setUb(self.__var, value)

    @property
    def type(self) -> str:
        """The type given with [VarType][flowty.constants.VarType]."""
        value = ffi.new("char *")
        libFlowty.FLWT_Var_getType(self.__var, value)
        return value[0]
    ...
    def x(self) -> float:
        ...
        value = ffi.new("double *")
        libFlowty.FLWT_Var_getX(self.__var, value)
        return value[0]
    ...
    def idx(self) -> int:
        ...
        value = ffi.new("int *")
        libFlowty.FLWT_Var_getIdx(self.__var, value)
        return value[0]
    ...
    def source(self) -> int:
        ...
        """
        value = ffi.new("int *")
        libFlowty.FLWT_Graph_getEdgeSource(self.__graph, self.__var, value)
        return value[0]
    ...
    def target(self) -> int:
        ...
        """
        value = ffi.new("int *")
        libFlowty.FLWT_Graph_getEdgeTarget(self.__graph, self.__var, value)
        return value[0]
    ...
    def edge(self) -> Tuple[int, int]:
        ...
        source = ffi.new("int *")
        target = ffi.new("int *")
        libFlowty.FLWT_Graph_getEdge(self.__graph, self.__var, source, target)
...
class Constr:
    ...
    def idx(self) -> int:
        ...
        value = ffi.new("int *")
        libFlowty.FLWT_Constr_getIdx(self.__constr, value)
        return value[0]
...
class Graph:
    ...
    def vars(self):
        ...
        num = ffi.new("int *")
        libFlowty.FLWT_Graph_getNumVars(self.__graph, num)
        num = num[0]
        array = ffi.new("FLWT_Var *[]", num)
        libFlowty.FLWT_Graph_getVars(self.__graph, array)
    ...
    def n(self):
        ...
        num = ffi.new("int *")
        libFlowty.FLWT_Graph_getN(self.__graph, num)
        return num[0]
    ...
    def m(self):
        """The number of edges."""
        num = ffi.new("int *")
        libFlowty.FLWT_Graph_getM(self.__graph, num)
        return num[0]
    ...
    def idx(self):
        ...
        value = ffi.new("int *")
        libFlowty.FLWT_Graph_getIdx(self.__graph, value)
        return value[0]
    ...
    def source(self):
        ...
        value = ffi.new("int *")
        libFlowty.FLWT_Graph_getSource(self.__graph, value)
        return value[0]
    ...
    def sink(self):
        ...
        value = ffi.new("int *")
        libFlowty.FLWT_Graph_getSink(self.__graph, value)
        return value[0]
