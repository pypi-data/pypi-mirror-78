...
int FLWT_LinEqua_new(FLWT_LinEqua **equa, FLWT_LinExpr *expr, char sense,
                     double rhs);
int FLWT_LinEqua_copy(FLWT_LinEqua **equa, FLWT_LinEqua *other);
...
int FLWT_Model_addConstr(FLWT_Model *model, FLWT_LinEqua *equa, char *name,
                         FLWT_Constr **constr);
int FLWT_Model_addGraph(FLWT_Model *model, int directed, double *obj,
                        int *from, int *to, int m, int source, int sink,
                        double L, double U, char type, char **names,
                        FLWT_Graph **graph);
...
int FLWT_Model_setObjective(FLWT_Model *model, FLWT_LinExpr *expr, FLWT_ObjSense sense);
...
int FLWT_Model_optimize(FLWT_Model *model, FLWT_OptimizationStatus *optimizationStatus);
...
int FLWT_Graph_getEdge(FLWT_Graph *graph, FLWT_Var *var, int *source, int *target);

typedef int FLWT_Callback(FLWT_CallbackModel* callbackModel, int where, void* userdata);
int FLWT_Model_setCallback(FLWT_Model* model, FLWT_Callback callback, void * userdata);
int FLWT_Model_setLicenseKey(FLWT_Model *model, char* user, char* key);

int FLWT_CallbackModel_getResource(FLWT_CallbackModel* callbackModel, char* name,
                                  double *value);
int FLWT_CallbackModel_getResourceOther(FLWT_CallbackModel* callbackModel, char* name,
                                        double* other);
int FLWT_CallbackModel_setResource(FLWT_CallbackModel* callbackModel, char* name,
                                   double value);
...
int FLWT_CallbackModel_getX(FLWT_CallbackModel *callbackModel, double *x, int size);
int FLWT_CallbackModel_addCut(FLWT_CallbackModel *callbackModel, FLWT_LinEqua *equa);
