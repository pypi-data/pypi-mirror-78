...
class CallbackModel:
    ...
    def skip(self):
        ...
        **skip** calls to the internal dynamic programming algorithm. Only paths added
        ...
        """
        libFlowty.FLWT_CallbackModel_skip(self.__callbackModel)
    ...
    def keep(self) -> None:
        ...
        """
        libFlowty.FLWT_CallbackModel_keep(self.__callbackModel)
    ...
    def k(self) -> int:
        ...
        """
        value = ffi.new("int *")
        libFlowty.FLWT_CallbackModel_getK(self.__callbackModel, value)
        return value[0]
    ...
    def vertex(self) -> int:
        ...
        value = ffi.new("int *")
        libFlowty.FLWT_CallbackModel_getVertex(self.__callbackModel, value)
        return value[0]
    ...
    def edge(self) -> int:
        ...
        value = ffi.new("int *")
        libFlowty.FLWT_CallbackModel_getEdge(self.__callbackModel, value)
        return value[0]
    ...
    def x(self) -> List[float]:
        ...
        **solution candidate**.
        ...
        """
        num = ffi.new("int *")
        libFlowty.FLWT_Model_getNumVars(self.__model, num)
        num = num[0]
        array = ffi.new("const double []", num)
        libFlowty.FLWT_CallbackModel_getX(self.__callbackModel, array, num)
    ...
    def reducedCost(self) -> List[float]:
        ...
        libFlowty.FLWT_CallbackModel_getReducedCost(self.__callbackModel, array, num)
        return [array[i] for i in range(num)]
    ...
    def convexDual(self) -> float:
        ...
        """
        value = ffi.new("double *")
        libFlowty.FLWT_CallbackModel_getConvexDual(self.__callbackModel, value)
        return value[0]
    ...
    def zeroEdges(self) -> List[int]:
        ...
        """
        num = ffi.new("int *")
        libFlowty.FLWT_CallbackModel_getNumZeroEdges(self.__callbackModel, num)
        num = num[0]
    ...
    def addPath(self, cost: float, eids: List[int]) -> None:
        ...
        libFlowty.FLWT_CallbackModel_addPath(self.__callbackModel, cost, array, size)
...
class Model:
    ...
    def __init__(self, name: str = ""):
        ...
        libFlowty.FLWT_Model_new(self.__model)
    ...
    def __del__(self):
        libFlowty.FLWT_Model_delete(self.__model)
    ...
    def name(self, name: str) -> None:
        libFlowty.FLWT_Model_setName(self.__model, name.encode("utf-8"))
    ...
    def vars(self) -> List[Var]:
        ...
        libFlowty.FLWT_Model_getVars(self.__model, array)
    ...
    def objectiveValue(self) -> float:
        """The objective value."""
        value = ffi.new("double *")
        libFlowty.FLWT_Model_getObjectiveValue(self.__model, value)
        return value[0]
    ...
    def addPackingSet(self, packingSet: List[Var]) -> None:
        ...
        libFlowty.FLWT_Model_addPackingSet(self.__model, varArray, size)
    ...
    def read(self, filename: str) -> None:
        ...
        """
        libFlowty.FLWT_Model_read(self.__model, filename.encode("utf-8"))
    ...
    def write(self, filename: str) -> None:
        ...
        Parameters:
            filename: The path to file.
        """
        libFlowty.FLWT_Model_write(self.__model, filename.encode("utf-8"))
    ...
    def optimize(self) -> OptimizationStatus:
        ...
        libFlowty.FLWT_Model_optimize(self.__model, status)
        status = status[0]
    ...
    def setParam(self, key: str, value: Union[str, int, float]) -> None:
        ...
        if isinstance(value, str):
            ...
            libFlowty.FLWT_Model_setParamInt(self.__model, key.encode("utf-8"), value)
        elif isinstance(value, float):
            libFlowty.FLWT_Model_setParamDbl(self.__model, key.encode("utf-8"), value)
        else:
