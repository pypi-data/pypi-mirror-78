...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', '3.22.0-alpha.1598872172+a1f9ebdf'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp 3.22.0-alpha.1598872172+a1f9ebdf`
                """)
            else:
                raise
