...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', '3.22.0-alpha.1598987604+c9a002b5'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp 3.22.0-alpha.1598987604+c9a002b5`
                """)
            else:
                raise
