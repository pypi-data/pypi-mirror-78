...
that is matching the value of the :attr:`ae_help_id`
...
class HelpAppBase(MainAppBase, ABC):
    ...
    def help_widget(self, help_id: str, help_vars: Dict[str, Any]) -> Any:
        ...
        :param help_id:         widget.ae_help_id attribute value for to detect widget and call stack locals.
        ...
        if not wid:
            if help_id:
                ...
                while depth <= 15:
                    ...
                    widget = lfv.get('self')
                    if getattr(widget, 'ae_help_id', None) == help_id:
                ...
                if not wid:
                    self.vpo(f"HelpAppBase.help_widget(): widget with ae_help_id '{help_id}' not found")
