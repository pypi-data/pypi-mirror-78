...
"""
    desc:pass
"""
from xmaios.monitor.model.Request import Request
from xmaios.monitor.model.Response import Response
from xmaios.monitor.Utils import Utils
from xmaios.monitor.BotMonitorConfig import BotMonitorConfig
    ...
    def _build_upload_data(self):
        ...
        ret_data = {
            'serviceData': {
                ...
                'intentToken': self.request.get_intent_token(),
                'sessionId': self.request.get_session_id(),
                'location': self.request.get_location(),
                'slotToElicit': self.response.get_slot_token(),
