...
class FetureSonarQubeQualityGates(SonarQubeQualityGates):
    def copy_quality_gate(self, source_name, gate_name, organization=None):
        """
        Copy a Quality Gate.

        :param source_name: The name of the quality gate to copy
        :param gate_name: The name of the quality gate to create
        :param organization: Organization key. If no organization is provided, the default organization is used.
        :return:
        """
        params = {'sourceName': source_name, 'name': gate_name}
    ...
    def delete_quality_gate(self, gate_name, organization=None):
        """
        Delete a Quality Gate.

        :param gate_name: Name of the quality gate to delete
        :param organization: Organization key. If no organization is provided, the default organization is used.
        :return:
        """
        params = {'name': gate_name}
    ...
    def rename_quality_gate(self, current_gate_name, new_gate_name, organization=None):
        """
        Rename a Quality Gate.

        :param current_gate_name: Current name of the quality gate
        :param gate_name: New name of the quality gate
        :param organization: Organization key. If no organization is provided, the default organization is used.
        :return:
        """
        params = {'currentName': current_gate_name, 'name': new_gate_name}
        if organization:
            params.update({"organization": organization})

        self.sonarqube.make_call('post', API_QUALITYGATES_RENAME_ENDPOINT, **params)

    def create_condition_to_quality_gate(self, gate_name, metric, error, op=None, organization=None):
        """
        Add a new condition to a quality gate.
    ...
    def get_qualitygate_projects(self, gate_name, selected="selected", organization=None, query=None):
        """
        Search for projects associated (or not) to a quality gate.

        :param gate_name: Quality Gate name
        :param selected: Depending on the value, show only selected items (selected=selected),
          deselected items (selected=deselected), or all items with their selection status (selected=all).
          Possible values are for:
            * all
    ...
    def set_default_qualitygate(self, gate_name, organization=None):
        """
        Set a quality gate as the default quality gate.

        :param gate_name: Name of the quality gate to set as default
        :param organization: Organization key. If no organization is provided, the default organization is used.
        :return:
        """
        params = {'name': gate_name}
    ...
    def select_quality_gate_for_project(self, project_key, gate_name, organization=None):
        """
        Associate a project to a quality gate.
