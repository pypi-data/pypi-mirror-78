...
setup(
    ...
    url='https://market_mix_model/apd_540@hotmail.com/market_mix_model',
    ...
    project_urls={
        ...
        'Issue Tracker': 'https://market_mix_model/apd_540@hotmail.com/market_mix_model/issues',
    },
    keywords=[
    ...
    install_requires=[
        'numpy>=1.16', 'scipy>=1.5','pandas>=1.1.0',
    ],
    extras_require={
            "dev":['numpy>=1.16','scipy>=1.5','pandas>=1.1.0'
                ]
        #   'rst': ['docutils>=0.11'],
