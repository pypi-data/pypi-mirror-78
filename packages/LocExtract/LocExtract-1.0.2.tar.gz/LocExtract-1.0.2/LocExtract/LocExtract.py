...
PCA_re =  '|'.join([k for k,v in PCA.items()])
PC_re =  '|'.join([k for k,v in PC.items()])
PA_re =  '|'.join([k for k,v in PA.items()])
CA_re =  '|'.join([k for k,v in CA.items()])
P_re = '|'.join([k for k,v in province_map.items()])
C_re = '|'.join([k for k,v in city_map.items()])
A_re = '|'.join([k for k,v in area_map.items()])
