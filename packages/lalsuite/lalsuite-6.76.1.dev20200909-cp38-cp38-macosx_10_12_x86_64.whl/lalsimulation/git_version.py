...
id = "e53a54a8cbeb334267f2a4337301db1d5d852a7f"
date = "2020-09-7 23:30:53 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "e53a54a8cbeb334267f2a4337301db1d5d852a7f":
        return
    msg = "Program id (e53a54a8cbeb334267f2a4337301db1d5d852a7f) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
