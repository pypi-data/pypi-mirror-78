...
if os.path.exists(my_version_file):
    ...
    pkg_info_files = (my_dir + "/PKG-INFO", my_dir + "/n0utils.egg-info/PKG-INFO")
...
setuptools.setup(
    name = "n0translate",
    version = _version,
    description = "Easy transliteration for Python3: dst_str = src_str.translate(n0translate.translit_dict)",
    author = "pythonist552",
    author_email = "pythonist552@gmail.com",
    long_description = "n0translate.translit_dict is a dictionary for Python3 str.translate(dict) allows to translit cyrillic/french/spanish and other latin like languages from UTF-8 into ASCII-7 encoding",
    long_description_content_type="text/markdown",    
    url = "https://github.com/pythonist552/n0translate/",
    license = 'ASL',
    # packages=['n0utils'],
