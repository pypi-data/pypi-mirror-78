...
from scrahub.core import SCRAHUB_TMP
from scrahub.core.config import config
from scrahub.core.request import Request
from scrahub.utils.scrapy import get_scrapy_cfg, get_items_fields, get_pipelines, get_spider_filepath
...
def get_ignore_matches():
    ...
    ignore_file = os.path.join(os.path.abspath(os.curdir), '.scrahubignore')
...
class Client(object):
    ...
    def upload_customized_spider(directory=None, name=None, col=None, display_name=None, command=None, id=None):
        ...
        target_path = os.path.join(SCRAHUB_TMP, name or os.path.basename(directory)) + '.zip'
