...
class UserTex():
    """Represents tex writing by the user that will appear in an assessment."""
    ...
    @classmethod
    def from_series(cls, series: object, tex_path: str = '') -> object:
        """Constructs a UserTex cell from a Pandas series."""
        ...
        user_tex = cls.from_dir(path, tex_path, **kwargs)
    ...
    def from_dir(cls, path: str, parent: str = None, **kwargs) -> object:
        ...
        user_tex = cls(path, tex_code, kwargs['title'])
