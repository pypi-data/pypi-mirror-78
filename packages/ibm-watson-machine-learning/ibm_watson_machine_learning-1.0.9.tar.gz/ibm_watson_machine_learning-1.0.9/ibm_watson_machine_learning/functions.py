...
""".format(code, function.__name__)
    ...
    def update(self, function_uid, changes, update_function=None):
        ...
        **Example**
        ...
        if self._client.ICP_30 is None and not self._client.CLOUD_PLATFORM_SPACES and update_function is not None:
        ...
        if (self._client.ICP_30 or self._client.CLOUD_PLATFORM_SPACES) and update_function is not None:
