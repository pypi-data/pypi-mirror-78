...
class PlatformSpaces(WMLResource):
    ...
    def store(self, meta_props, background_mode=True):
        """
                Create a space. The instance associated with the space will be used for billing purposes
        ...
        #
        if 'compute' in spaces_details['entity'].keys():
    ...
    def delete(self, space_id):
        ...
        return self._handle_response(202, u'space deletion', response_delete, False)
...
#######SUPPORT FOR SPACE MEMBERS
    ...
    def get_member_details(self, space_id, member_id):
        ...
        return self._get_no_space_artifact_details(href, member_id, None, 'space members')
