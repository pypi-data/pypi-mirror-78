...
from ibm_watson_machine_learning.tests.utils import get_wml_credentials, get_cos_credentials, bucket_exists, bucket_name_gen, get_space_id
...
class TestAutoAIRemote(unittest.TestCase):
    ...
    def setUp(cls) -> None:
        ...
        space_cleanup(cls.wml_client,
                      get_space_id(cls.wml_client, cls.space_name,
                                   cos_resource_instance_id=cls.cos_resource_instance_id),
                      days_old=2)
