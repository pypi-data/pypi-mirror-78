...
class TestAutoAIRemote(unittest.TestCase):
    ...
    project_id = None
    space_id = 'e1c2698f-d5fb-48b0-a62d-3261180898cb'
    ...
    def setUp(cls) -> None:
        ...
        space_cleanup(cls.wml_client,
                      get_space_id(cls.wml_client, cls.space_name, cos_resource_instance_id=cls.cos_resource_instance_id),
                      days_old=2)
        cls.space_id = get_space_id(cls.wml_client, cls.space_name, cos_resource_instance_id=cls.cos_resource_instance_id)
        cls.project_id = None

        cls.wml_client = APIClient(wml_credentials=cls.wml_credentials.copy())
        cls.wml_client.set.default_space(cls.space_id)
