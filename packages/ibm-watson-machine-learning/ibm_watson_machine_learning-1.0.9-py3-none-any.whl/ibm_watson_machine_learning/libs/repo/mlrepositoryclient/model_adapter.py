...
class ModelAdapter(object):
    ...
    def artifact(self):
        if re.match('mllib', self.model_type) is not None:
        ...
        elif re.match('wml_1.', self.model_type) is not None:
            lib_checker.check_lib(PYSPARK)
            ...
            model_artifact_builder = type(
             ...
             re.match('wml-hybrid', self.model_type) is not None:
            model_artifact_builder = type(
                "HybridModelArtifact",
        ...
        if self.model_metadata.id is not None and href_tmp is None:
            ...
            if self.model_metadata.project_id is not None:
                prop_map[MetaNames.PROJECT_UID] = self.model_metadata.project_id
