...
class Project_from_schema(object):
    """A project."""

    def __init__(self, schema, **kwargs):
        """Create a project."""
        self.schema = schema
        self.dict = parse(etree.tostring(etree.parse(
            resource_filename(__name__, schema)
            )))
        print(unparse(self.dict))


class ProjectSet_from_schema(object):
    """A project set."""
