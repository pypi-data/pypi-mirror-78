...
class PFData(_object):
    ...
    def writeFile(self, *args) -> "int":
        return _pyParflowio.PFData_writeFile(self, *args)
    ...
    def getData(self, *args) -> "double const *":
        return _pyParflowio.PFData_getData(self, *args)

    def setData(self, arg2: 'double *') -> "void":
        return _pyParflowio.PFData_setData(self, arg2)
