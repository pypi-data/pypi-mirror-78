...
class AttributeMetadata(Metadata):
    ...
    def __init__(self, name: str, text: str, type_name: str,
        ...
        :param text: The text representation of the attribute in the survey data.
        :param type_name: The type of the attribute.
        :param ordered: Whether the values of the attribute are ordered.
        :param expression: Optional regular expression for matching multiple columns for the same attribute,
                           or for matching single columns that need renaming.
        :param loop_variables: A list of variables over which the original attribute has been looped, this metadata
                              instance representing the metadata for one of the loop instances.
        :param loop_expression: Regular expression for matching the particular loop instance for a given attribute.
        """
        self.name = name
        self.text = text
    ...
    def from_dataframe(data: DataFrame) -> List['AttributeMetadata']:
        ...
        :param data: DataFrame containing columns with the names of AttributeMetadata attributes.
        """
