...
class Package:
    ...
    def pull_submodule(self,ignore_assets=False):
        ...
        try:
            ...
            copy_assets_path = file_path = os.getcwd() + '/' + 'image.json'
            ...
            for moduleConfig in moduleConfigList:
                ...
                ignore_assets_path = is_key_in_json(current_submodule,copy_assets_path)
                if ignore_assets and have_copy_assets_sh and (ignore_assets_path is not None):
                    sub_remote.pull('--assume-unchanged',ignore_assets_path)
                else:
                    sub_remote.pull()
        ...
        with open(file,'r',encoding='utf8')as fp:
            ...
            for assets_item in assets_list:
                if key in assets_item['image']:
                    assets_path = assets_item['assets']
                    break
        return assets_path
