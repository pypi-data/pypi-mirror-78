...
- was.r is current request context namespace.
- was.g is global app context namespace.
...
.. code:: python
  ...
  def view_account (was, userid):
    was.r.user_id = "jerry"
    was.r.user_status = "active"
    was.r.resouce = open ()
    return ...

For this situation, 'was' provide was.r that is empty class instance.
was.r is valid only in current request. After end of current request.
...
.. code:: html
  ...
  Checkout for {{ was.r.howmany }} {{ was.r.product }}{{ was.r.howmany > 1 and "s" or ""}}
...
.. code:: python
  ...
  @app.login_required
  def intro (was):
    was.r.aa = was.get ("https://example.com/blur/blur")
    was.r.bb = was.get ("https://example.com/blur/blur/more-blur")
...
.. code:: html
  ...
  {% set response = was.r.aa.dispatch () %}
...
.. code:: html
  ...
  {% set response = was.r.aa.dispatch_or_throw ("500 Internal Server Error") %}
...
- 0.8  (Feb, 2020)
  ...
  - add was.r for current request context, was.g is changed to global
