...
class Solution:
    def __init__(self, components):
        ...
        def cpu_set_variable(cpu, arch):
            ...
            if cpu.lower() == 'rv32emc' or cpu.lower().startswith('e') or cpu.lower().startswith('c'):
                if cpu.lower() == 'rv32emc':
                    self.variables.set('cpu_num', 'rv32')
                elif cpu.lower() == 'e902':
                    self.variables.set('cpu_num', 'rv32_16gpr')
                elif cpu.lower() == 'e902m':
                    self.variables.set('cpu_num', 'rv32_16gpr')
                elif cpu.lower() == 'e902t':
                    self.variables.set('cpu_num', 'rv32_16gpr')
                elif cpu.lower() == 'e902mt':
                    self.variables.set('cpu_num', 'rv32_16gpr')
                elif cpu.lower() == 'e906':
                    ...
                    self.variables.set('cpu_num', 'rv64_32gpr')
                elif cpu.lower() == 'c906fd':
                    self.variables.set('cpu_num', 'rv64fd_32gpr')
                elif cpu.lower() == 'c906v':
                    self.variables.set('cpu_num', 'rv64fd_32gpr')
                elif cpu.lower() == 'c910':
                    self.variables.set('cpu_num', 'rv64fd_32gpr')
                elif cpu.lower() == 'c910v':
                    self.variables.set('cpu_num', 'rv64fd_32gpr')
                else:
