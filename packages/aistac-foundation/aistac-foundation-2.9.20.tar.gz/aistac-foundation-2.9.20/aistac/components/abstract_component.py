...
class AbstractComponent(ABC):
    ...
    REPORT_NOTES = 'notes'
    REPORTS_LIST = [REPORT_SCHEMA, REPORT_INTENT, REPORT_NOTES]
    # template connectors
    ...
    def _init_properties(cls, property_manager: AbstractPropertyManager, uri_pm_path: str, uri_pm_repo: str=None,
                         pm_file_type: str=None, pm_module: str=None, pm_handler: str=None, has_contract: bool=None,
                         pm_kwargs: dict=None):
        ...
        if HandlerFactory.instantiate(_connector).exists():
            ...
            property_manager.set_property_connector(connector_contract=_pm_connector)
        elif isinstance(has_contract, bool) and has_contract:
    ...
    def set_report_persist(self, report_names: [str, list]=None, save: bool=None, **kwargs):
        ...
        _reports = [self.REPORT_NOTES, self.REPORT_SCHEMA, self.REPORT_INTENT]
