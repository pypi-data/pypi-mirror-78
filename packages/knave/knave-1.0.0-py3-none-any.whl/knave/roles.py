...
class RoleProvider(object):
    ...
    def any_matching(self, roles, identity, context=None):
        ...
        :rtype: :class:`set`
        """
        return self.member_subset(roles, identity, context)
...
class CachingRoleProvider(RoleProvider):
    ...
    def member_subset(self, roles, identity, context=None):
        return self._member_subset(
            self.provider.member_subset, roles, identity, context
        )

    def any_matching(self, roles, identity, context=None, environ=None):
        return self._member_subset(
            self.provider.any_matching, roles, identity, context
        )
...
class MultiRoleProvider(RoleProvider):
    ...
    def member_subset(self, roles, identity, context=None, stop_on_match=False):
        result = set()
...
class StaticRoleProvider(RoleProvider):
    ...
    def __init__(self, user_roles):
        ...
        self.user_roles = dict(
            (userid, set(roles)) for userid, roles in user_roles.items()
        )
