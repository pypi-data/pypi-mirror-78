...
from pickle import _Pickler, dispatch_table
...
class parpool(object):
    ...
    @fun.setter
    def fun(self, fun):
        funs = dill.dumps(fun, recurse=True)
    ...
    @args.setter
    def args(self, args):
        argss = dill.dumps(args, recurse=True)
    ...
    def kwargs(self, kwargs):
        kwargss = dill.dumps(kwargs, recurse=True)
