...
setup(
  ...
  download_url = 'https://github.com/yepiwt/syncmm/archive/3.1.tar.gz',    # I explain this later on
  keywords = ['Sync', 'Music', 'vk', 'yandex', 'yandex_music'],   # Keywords that define your package best
