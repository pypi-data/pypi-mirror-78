...
def quick_color_lines(path_evr  = None,
    ...
    - **Parameters**
        ...
        - colors     : List ['red',] of orbitals colors (str,rgb,rgba), len(colors)==len(orbs) must hold.
...
def quick_dos_lines(path_evr      = None,
        ...
        if(len(tdos)==2):
            clrs=[[c,gu.invert_color(color=mpl.colors.to_rgb((c)))] for c in colors]
            colors=[c for cs in clrs for c in cs]
