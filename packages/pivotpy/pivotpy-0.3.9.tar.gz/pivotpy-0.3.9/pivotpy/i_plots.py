...
def plotly_dos_lines(path_evr     = None,
        ...
        - **Parameters**)
            ...
            - ions       : List [] of ions indices, by defualt and plot first ion's projections.
            ...
            - colors     : List ['red',] of orbitals colors {str,rgb,rgba}, len(colors)==len(orbs) must hold. Use matplotlib colors values, it will be changed to plotly's colors automatically.
