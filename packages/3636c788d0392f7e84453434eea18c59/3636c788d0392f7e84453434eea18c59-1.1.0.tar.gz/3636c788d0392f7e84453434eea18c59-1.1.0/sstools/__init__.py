...
def airbnb_search(place_ids = ["ChIJRYHfiwkB6DsRWIbipWBKa2k"], max_iters = 5, min_price=4000,max_price=50000, home_type=[],amenities=[], min_bedrooms=1 ):
  ...
  for place_id in place_ids:
    ...
    while counter<=max_iters:  
      ...
      if not response['data']['dora']['exploreV3']['sections']:
        ...
        all_items.extend(response['data']['dora']['exploreV3']['sections'][1]['items'])
