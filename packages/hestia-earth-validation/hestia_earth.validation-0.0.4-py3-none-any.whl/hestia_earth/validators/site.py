...
from .shared import list_has_props, validate_dates, validate_list_dates, diff_in_years
...
def validate_site(site: dict):
    return [
        ...
        validate_soilTexture(site['measurements']) if 'measurements' in site else True,
        validate_depths(site['measurements']) if 'measurements' in site else True,
        validate_lifespan(site['infrastructure']) if 'infrastructure' in site else True
    ]
