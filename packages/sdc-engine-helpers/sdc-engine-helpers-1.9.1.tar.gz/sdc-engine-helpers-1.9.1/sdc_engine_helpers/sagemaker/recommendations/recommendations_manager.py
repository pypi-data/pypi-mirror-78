...
class RecommendationsManager:
    ...
    def encode_item_code(
        ...
        print("Cached Key = {}".format(cache_key))
        print("keys found = {}".format(key_exists))
        if key_exists == 0:
            raise Exception("ServerError: Item Code lookup could not be found in cache.")
    ...
    def decode_item_code(
        ...
        print("keys found = {}".format(key_exists))
        if key_exists == 0:
            raise Exception("ServerError: Item ID lookup could not be found in cache.")
