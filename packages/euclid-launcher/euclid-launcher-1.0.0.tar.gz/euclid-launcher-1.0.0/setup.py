...
setup(
    ...
    description='A commandline program for managing and launching projects.',
    download_url="https://github.com/brenodega28/Euclid/archive/v_01.tar.gz",
    version='1.0.0',
    ...
    entry_points='''
        [console_scripts]
        euclid=src.main:main
    ''',
    author="Breno Gomes",
    long_description=README,
    long_description_content_type="text/markdown",
    license='MIT',
    url='https://github.com/brenodega28/Euclid',
