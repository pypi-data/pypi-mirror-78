...
class MySql():
    ...
    @error_report
    def create_table(self, table_name = '', pri_key_name = '', engine = 'InnoDB', charset = 'utf8', **value_dict):
        """
        创建新表
...
mysql = MySql('1652829','aassddff','shockwave')
print(mysql.insert('userb',('user_id','user_name','user_password','user_icon','regist_time'),(123,'a','a','a','a')))
