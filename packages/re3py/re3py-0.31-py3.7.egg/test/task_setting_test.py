import unittest
from data.task_settings import *
...
class SplitTest(unittest.TestCase):
    ...
    def test_ok(self):
        s = Settings(self.ok)
        r, a, t, p = s.get_relations(), s.get_aggregates(), s.get_atom_tests(
        ), s.get_tree_parameters()
        true_r = [
            Relation("x", set(), None, ["Person", "c"]),
    ...
    def test_structured_atom_tests(self):
        ...
        answer = {
            ...
            ("someRelation", ('old', 'old', 'new', 'old', 'old', 'old', 'old'), ("A", "B", "A", "C", "C", "B", "A")):
            {
                "A": [[0, 6], [2], []],
                "B": [[1, 5], [], []],
                "C": [[3, 4], [], []]
            },
            ("someRelation", ('old', 'c', 'new', 'old', 'c', 'old', 'c'), ("A", "B", "A", "C", "C", "B", "A")):
            {
                "A": [[0], [2], [6]],
                "B": [[5], [], [1]],
                "C": [[3], [], [4]]
