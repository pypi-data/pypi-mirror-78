...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'hi', 'ka', 'th', 'uz', 'tt', 'la', 'cy', 'ta', 'vo', 'mk', 'ast',
        'lv', 'tg', 'zh-yue', 'bn', 'af', 'mg', 'oc', 'bs', 'sq', 'ky', 'nds',
        'new', 'be-tarask', 'ml', 'te', 'tl', 'br', 'pms', 'mr', 'su', 'sw',
        ...
        'bug', 'wa', 'xmf', 'sd', 'mai', 'hsb', 'map-bms', 'fo', 'mzn', 'li',
        ...
        'co', 'tk', 'so', 'fiu-vro', 'lrc', 'csb', 'kv', 'ha', 'ie', 'gv',
        'udm', 'pcd', 'ay', 'kab', 'zea', 'nrm', 'sat', 'ug', 'lij', 'kw',
        'lez', 'frp', 'stq', 'lfn', 'zu', 'gn', 'mwl', 'ban', 'gom', 'rm',
        'mt', 'lo', 'lad', 'koi', 'fur', 'olo', 'dty', 'ang', 'dsb', 'bjn',
        'ext', 'ln', 'cbk-zam', 'dv', 'ksh', 'gag', 'pfl', 'tyv', 'pag', 'pi',
        'av', 'awa', 'ary', 'haw', 'bxr', 'xal', 'krc', 'pap', 'za', 'pdc',
        'kaa', 'rw', 'szy', 'arc', 'to', 'nov', 'jam', 'tpi', 'kbp', 'kbd',
        'ig', 'na', 'tet', 'inh', 'wo', 'tcy', 'ki', 'jbo', 'atj', 'roa-rup',
        'bi', 'lbe', 'kg', 'ty', 'lg', 'mdf', 'srn', 'xh', 'fj', 'gcr', 'ltg',
        'chr', 'lld', 'ak', 'sm', 'om', 'kl', 'got', 'pih', 'cu', 'ny', 'tn',
