    ...
    """
{
    ...
    "package_data": {
        "cloudcomponents.cdk_cloudfront_authorization._jsii": [
            "cdk-cloudfront-authorization@1.1.4.jsii.tgz"
        ],
        "cloudcomponents.cdk_cloudfront_authorization": [
            "py.typed"
        ]
    ...
    "python_requires": ">=3.6",
    "install_requires": [
        "aws-cdk.aws-certificatemanager>=1.62.0, <2.0.0",
        "aws-cdk.aws-cloudfront-origins>=1.62.0, <2.0.0",
        "aws-cdk.aws-cloudfront>=1.62.0, <2.0.0",
        "aws-cdk.aws-cognito>=1.62.0, <2.0.0",
        ...
        "cloudcomponents.cdk-deletable-bucket>=1.0.28, <2.0.0",
        "cloudcomponents.cdk-lambda-at-edge-pattern>=1.0.11, <2.0.0",
