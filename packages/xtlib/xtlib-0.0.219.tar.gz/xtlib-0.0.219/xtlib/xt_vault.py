...
class XTVault():
    ...
    def __init__(self, vault_url, ss_name):
    ...
    def _load_grok_creds(self):
        ...
        if not os.path.exists(fn_keys):
            fn_keys = os.path.expanduser("~/.xt/service_sets/{}/keys.bin".format(self.ss_name))
