...
def build_cmds(auto_mode, quick_test, nomonitor, nogui, philly=1, basic_mode=None, store=None):
...
def parse_args(arg_list=None):
    ...
    parser.add_argument('--store', default=0, type=str, help='the name of the store being used in config file')
