...
class Package(SirenComponent):
    ...
    def get_package(self, id=None, name=None):
        ...
        """
        # warnings.warn(
        #     "Deprecation Warning: retrieving a package (and other CRUD package operations) using SDK "
        #     "get_package will be deprecated in near future (by November 2020). The API should be used "
        #     "instead, full details on how to use API can be found by signing in to 'https://catalogue-uat.datalake.ihsmarkit.com' then opening the page 'https://catalogue-uat.datalake.ihsmarkit.com/__api/v2/swagger?urls.primaryName=packages'.",
    ...
    def get_package_datasets(self, package_id, count=100):
        ...
        """
        # warnings.warn(
        #     "Deprecation Warning: retrieving the list of datasets contained in a package "
        #     "(and other CRUD package operations) using SDK "
        #     "get_package_datasets will be deprecated in near future (by November 2020). The API should be used "
        #     "instead, full details on how to use API can be found by signing in to 'https://catalogue-uat.datalake.ihsmarkit.com' then opening the page 'https://catalogue-uat.datalake.ihsmarkit.com/__api/v2/swagger?urls.primaryName=packages'.",
        #     PendingDeprecationWarning
        # )
