...
extern "C" {
#endif
PETSC_EXTERN void  snesapplynpc_(SNES snes,Vec x,Vec f,Vec y, int *__ierr){
*__ierr = SNESApplyNPC(
...
PETSC_EXTERN void  snesgetnpcfunction_(SNES snes,Vec F,PetscReal *fnorm, int *__ierr){
