...
extern "C" {
#endif
PETSC_EXTERN void  dmredundantsetsize_(DM dm,PetscMPIInt *rank,PetscInt *N, int *__ierr){
*__ierr = DMRedundantSetSize(
	(DM)PetscToPointer((dm) ),*rank,*N);
}
PETSC_EXTERN void  dmredundantgetsize_(DM dm,PetscMPIInt *rank,PetscInt *N, int *__ierr){
