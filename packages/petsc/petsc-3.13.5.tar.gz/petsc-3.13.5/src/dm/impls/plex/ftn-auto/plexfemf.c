...
PETSC_EXTERN void  dmplexcreaterigidbody_(DM dm,MatNullSpace *sp, int *__ierr){
...
PETSC_EXTERN void  dmplexcomputeinterpolatornested_(DM dmc,DM dmf,Mat In,void*user, int *__ierr){
