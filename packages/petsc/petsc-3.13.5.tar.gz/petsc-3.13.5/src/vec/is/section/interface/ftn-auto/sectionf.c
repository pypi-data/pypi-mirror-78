...
PETSC_EXTERN void  petscsectionsetclosurepermutation_(PetscSection section,PetscObject obj,IS perm, int *__ierr){
*__ierr = PetscSectionSetClosurePermutation(
	(PetscSection)PetscToPointer((section) ),
	(PetscObject)PetscToPointer((obj) ),
	(IS)PetscToPointer((perm) ));
}
PETSC_EXTERN void  petscsectiongetclosurepermutation_(PetscSection section,PetscObject obj,IS *perm, int *__ierr){
*__ierr = PetscSectionGetClosurePermutation(
	(PetscSection)PetscToPointer((section) ),
	(PetscObject)PetscToPointer((obj) ),perm);
}
PETSC_EXTERN void  petscsectiongetclosureinversepermutation_(PetscSection section,PetscObject obj,IS *perm, int *__ierr){
