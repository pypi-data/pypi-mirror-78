...
except: # create wqrfnium_app.ini
    cfp = configparser.ConfigParser()
...
if elements_xls_path == '': #no path
    ...
    print('You are first use wqrfnium_app,it is creating elements.xls,you must edit elements.xls and play wqrfnium_app after!')
    print('这是您第一次使用wqrfnium_app,它正在自动创建元素表elements.xls,您必须在这次启动后再去使用wqrfnium_app和添加元素到elements.xls等操作！')
