...
class HomeView(AdminIndexView):
    ...
    def index(self, session=None):
        ...
        authority_lst = current_user.get_authority()
        if authority_lst:
            # print(current_user.user.username,current_user.get_authority())
            authority_lst = authority_lst.split(',')
        else:
            authority_lst = [current_user.user.username]
