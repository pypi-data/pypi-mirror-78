    ...
    def generate_fuzz_report():
        ...
        for test in report["report"]["tests"]:
            ...
            if fuzz_type not in consolidated_report[api_name][api_method]:
                ...
                consolidated_report[api_name][api_method][fuzz_type]["duration"].append(test["duration"])
        ...
        for api, info in consolidated_report.items():
            for method, fuzz_info in info.items():
                ...
                record = {"name": api, "method": method, "test_duration": info["duration"], "app": "Omnicenter",
                          "spec": "openapi_spec.json", "total_tests": total_tests,
                          "success_tests": success_tests,
                          "failed_tests": failed_tests, "fuzz_type": type}
