...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'mongodbatlas', '1.3.0-alpha.1599152642+e7b0bfc5'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource mongodbatlas 1.3.0-alpha.1599152642+e7b0bfc5`
                """)
            else:
                raise
