...
[boto3.Appflow 1.14.54](https://boto3.amazonaws.com/v1/documentation/api/1.14.54/reference/services/appflow.html#Appflow) service
...
`mypy_boto3_appflow` and other installed services.
...
session_client = boto3.Session().client("appflow")
```
