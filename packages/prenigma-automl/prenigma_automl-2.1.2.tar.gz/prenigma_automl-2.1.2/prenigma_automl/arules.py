...
def setup(data, 
    ...
    executing any other function in prenigma_automl. It takes three mandatory parameters:
    ...
    dataset. prenigma_automl will internally convert the pandas.DataFrame into a sparse matrix 
...
def plot_model(model,
               plot = '2d',
               scale = 1, #added in prenigma_automl 2.1.0
               ):
