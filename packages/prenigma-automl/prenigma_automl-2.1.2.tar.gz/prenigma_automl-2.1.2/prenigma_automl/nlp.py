...
def setup(data, 
    ...
    Warnings
    --------
    - Some functionalities in prenigma_automl.nlp requires you to have english language model. 
      The language model is not downloaded automatically when you install prenigma_automl. 
    ...
    logger.info("prenigma_automl NLP Module")
