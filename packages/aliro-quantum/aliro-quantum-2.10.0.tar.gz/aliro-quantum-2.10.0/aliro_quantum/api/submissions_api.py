...
class SubmissionsApi(object):
    ...
    def submissions_post(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param Submission submission_post_parameters: Submission must include at least one circuit with a name, language, and body
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def submissions_post_with_http_info(self, **kwargs):  # noqa: E501
        ...
        body_params = None
        if 'submission_post_parameters' in local_var_params:
            body_params = local_var_params['submission_post_parameters']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
