...
class V1alpha1VirusTableField(object):
    ...
    allowable_values = [UNSPECIFIED, ACCESSION, SPECIES_TAX_ID, SPECIES_NAME, GENUS, FAMILY, NUCLEOTIDE, LENGTH, ISOLATE_NAME, SEQUENCE_TYPE, NUC_COMPLETENESS, GEO_LOCATION, US_STATE, HOST_NAME, HOST_TAX_ID, COLLECTION_DATE, BIOPROJECT, BIOSAMPLE, POLYPROTEIN_NAME, PROTEIN_NAME, PROTEIN_ACCESSION, PROTEIN_SYNONYM]  # noqa: E501
