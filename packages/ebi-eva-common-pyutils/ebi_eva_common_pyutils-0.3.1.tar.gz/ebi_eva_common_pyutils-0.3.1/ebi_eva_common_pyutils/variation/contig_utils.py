...
def resolve_chromosome_name_to_contig_accession(contig_accession, line_limit=100):
...
def get_chromosome_name_for_contig_accession(contig_accession):
    ...
    return \
        resolve_chromosome_name_to_contig_accession(contig_accession, 1000) or \
        resolve_chromosome_name_to_contig_accession(contig_accession, 10000) or \
        resolve_chromosome_name_to_contig_accession(contig_accession, 100000)
