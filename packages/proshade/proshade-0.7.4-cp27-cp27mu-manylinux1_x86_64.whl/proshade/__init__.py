...
class ProSHADE_data(_object):
    ...
    def writePdb(self, fName, euA=0.0, euB=0.0, euG=0.0, transX=0.0, transY=0.0, transZ=0.0):
        return _proshade.ProSHADE_data_writePdb(self, fName, euA, euB, euG, transX, transY, transZ)
...
class ProSHADE_run(_object):
    ...
    def getTranslation(self):
        return _proshade.ProSHADE_run_getTranslation(self)
...
def getOptimalTranslation(run, translate):
    return _proshade.getOptimalTranslation(run, translate)
getOptimalTranslation = _proshade.getOptimalTranslation
