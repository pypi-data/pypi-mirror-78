...
namespace __pythran_landscape
{
  ...
  {
    {
      static typename __transonic__::type::result_type tmp_global = pythonic::types::make_tuple(pythonic::types::str("0.4.4"));
      return tmp_global;
    }
  }
  template <typename argument_type0 , typename argument_type1 >
  typename compute_adjacency_arr::type<argument_type0, argument_type1>::result_type compute_adjacency_arr::operator()(argument_type0&& padded_arr, argument_type1&& num_classes) const
  {
    ...
    typename pythonic::lazy<__type40>::type vertical_neighbours = typename pythonic::assignable<typename __combined<typename __combined<pythonic::types::list<typename std::remove_reference<typename pythonic::assignable<typename std::tuple_element<1,typename std::remove_reference<decltype(pythonic::builtins::getattr(pythonic::types::attr::SHAPE{}, std::declval<typename std::remove_cv<typename std::remove_reference<argument_type0>::type>::type>()))>::type>::type>::type>::type>,pythonic::types::list<typename std::remove_reference<decltype(pythonic::operator_::neg(std::declval<typename pythonic::assignable<typename std::tuple_element<1,typename std::remove_reference<decltype(pythonic::builtins::getattr(pythonic::types::attr::SHAPE{}, std::declval<typename std::remove_cv<typename std::remove_reference<argument_type0>::type>::type>()))>::type>::type>::type>()))>::type>>::type,pythonic::types::list<typename std::remove_reference<typename __combined<typename std::remove_cv<typename std::remove_reference<decltype(pythonic::operator_::neg(num_cols_pixel))>::type>::type,typename std::remove_cv<typename std::remove_reference<decltype(num_cols_pixel)>::type>::type>::type>::type>>::type>::type({num_cols_pixel, pythonic::operator_::neg(num_cols_pixel)});
    ...
    {
      long  __target140590366306768 = end;
      for (long  i=pythonic::operator_::add(num_cols_pixel, 1L); i < __target140590366306768; i += 1L)
      {
...
PYTHRAN_MODULE_INIT(landscape)(void) {
    ...
    PyObject * theDoc = Py_BuildValue("(sss)",
                                      "0.9.6",
                                      "2020-09-02 12:17:34.264202",
                                      "fb5f52e881df9f02629bafccb3e6b6f027bb83fe6be4d0733b43c4fb3f4b7cb5");
    if(! theDoc)
        PYTHRAN_RETURN;
