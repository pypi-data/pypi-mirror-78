...
from vodajemokra.user import User
from vodajemokra.party import PartyMember
...
class Converter:
    ...
    special cased ``vodajemokra`` classes.
...
class UserConverter(IDConverter):
    """Converts to a :class:`~vodajemokra.User`.
...
class PartyMemberConverter(IDConverter):
    """Converts to a :class:`~vodajemokra.PartyMember`.
...
class FriendConverter(IDConverter):
    """Converts to a :class:`~vodajemokra.Friend`.
