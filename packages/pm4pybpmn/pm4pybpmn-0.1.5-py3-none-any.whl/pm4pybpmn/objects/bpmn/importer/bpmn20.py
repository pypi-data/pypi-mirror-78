from pm4pybpmn.objects.bpmn.importer.bpmn_diagram_import import BpmnDiagramGraphImport
from pm4pybpmn.objects.bpmn.importer import bpmn_diagram_rep as diagram
