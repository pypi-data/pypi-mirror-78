...
from cizohosubscriptions.addon import Addon
from cizohosubscriptions.customer import Customer
from cizohosubscriptions.hostedpage import HostedPage
from cizohosubscriptions.invoice import Invoice
from cizohosubscriptions.plan import Plan
...
class Subscription:
    ...
    def cancel_immediately(self, subscription_id):
        return self.client.send_request("POST", 'subscriptions/%s/cancel?cancel_at_end=false' % subscription_id)

    def delete(self, subscription_id):
        return self.client.send_request("DELETE", 'subscriptions/%s' % subscription_id)
