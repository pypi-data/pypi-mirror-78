...
def pipeline_function(func):
    ...
    The first keyword argument of func must be data: pd.DataFrame.
    ...
    if len(arguments) == 0 or arguments[0] != "data":
        raise TypeError(
            ...
            + "Either remove @pipeline_function decorator or make 'data: pd.Dataframe' the first keyword argument."
        )
