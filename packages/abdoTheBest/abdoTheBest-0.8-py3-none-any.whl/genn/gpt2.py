...
from controllers import checkParams, readFiles, timeChecker, getStartWords, checkFileParams, checkProb
import time
...
class GPT2:
	...
	def generateDocument(self, n=10, selection='nucleus', genIter=None, k=5, prob=0.8, uniq=True):
