...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, name=None, repository_version=None, base_path=None, repository=None, pulp_href=None, pulp_created=None, content_guard=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
