...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, content_guard=None, name=None, pulp_created=None, pulp_href=None, base_path=None, repository_version=None, repository=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
