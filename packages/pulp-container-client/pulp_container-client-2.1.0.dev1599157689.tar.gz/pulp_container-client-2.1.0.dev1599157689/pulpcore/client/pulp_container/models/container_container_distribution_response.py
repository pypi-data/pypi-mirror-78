...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, repository=None, pulp_href=None, name=None, content_guard=None, base_path=None, repository_version=None, pulp_created=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
