...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, repository=None, repository_version=None, name=None, content_guard=None, pulp_href=None, base_path=None, pulp_created=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
