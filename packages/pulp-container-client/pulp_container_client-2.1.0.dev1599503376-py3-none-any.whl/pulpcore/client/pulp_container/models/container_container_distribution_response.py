...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, name=None, pulp_href=None, base_path=None, repository=None, pulp_created=None, repository_version=None, content_guard=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
