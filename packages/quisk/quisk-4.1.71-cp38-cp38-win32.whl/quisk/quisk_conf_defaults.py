...
# The level of the Tx audio sent to SoftRock hardware after all processing as a fraction 0.0 to 1.0.
# The level should be below 1.0 to allow headroom for amplitude and phase adjustments.
