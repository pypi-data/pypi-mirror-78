...
class GraphScreen(wx.Window):
  ...
  def OnLeftDown(self, event):
    ...
    if mouse_y < self.originY:		# click above X axis
      ...
      if shift:
      ...
      elif application.mode in ('CWU', 'CWL') and hasattr(self, "raw_graph_data"):
        # Move to a nearby peak
        ...
        if CW_x2 > len(self.raw_graph_data) - 1:
          CW_x2 = len(self.raw_graph_data) - 1
        ...
        if CW_max - CW_avg > 5 and CW_max > yp and CW_max > ym:
          ...
          #print (ym, CW_max, yp, 'CW_x', CW_x, 'CW_correct', CW_correct, 'sum', CW_x + CW_correct)
          CW_x += CW_correct
