...
setup(
  ...
  version = '1.1.18',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://gitlab.com/antoreep_jana/quick_ml/-/archive/v1.1.18/quick_ml-v1.1.18.tar.gz',    # I explain this later on
