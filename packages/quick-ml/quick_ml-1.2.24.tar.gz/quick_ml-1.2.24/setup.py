...
setup(
  ...
  version = '1.2.24',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://gitlab.com/antoreep_jana/quick_ml/-/archive/v1.1.24/quick_ml-v1.1.24.tar.gz',    # I explain this later on
