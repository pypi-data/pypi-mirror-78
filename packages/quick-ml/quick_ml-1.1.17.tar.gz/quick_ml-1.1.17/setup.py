...
setup(
  ...
  version = '1.1.17',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://gitlab.com/antoreep_jana/quick_ml/-/archive/v1.1.17/quick_ml-v1.1.17.tar.gz',    # I explain this later on
