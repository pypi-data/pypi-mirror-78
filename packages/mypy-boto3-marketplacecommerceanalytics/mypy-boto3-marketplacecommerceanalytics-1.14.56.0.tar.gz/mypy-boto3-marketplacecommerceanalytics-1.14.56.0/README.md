...
[boto3.MarketplaceCommerceAnalytics 1.14.56](https://boto3.amazonaws.com/v1/documentation/api/1.14.56/reference/services/marketplacecommerceanalytics.html#MarketplaceCommerceAnalytics) service
compatible with
