...
tt = {'lunette':[], 'chemise':[], 'chausson':[], 'maroquinerie':[], 'maillot bain':[], 'sacherie':[], 'couvrant':[], 'tablier':[], 'cheveux':[], 'nupieds':[], 'sous vetement':[], 'pantalon':[], 'jupe':[], 'divers':[], 'chaussure montante':[], 'tout petit':[], 'marketing':[], 'echarpe':[], 'ensemble':[], 'gant':[], 'bain':[], 'sommeil et detente':[], 'tshirt':[], 'grosse piece':[], 'robe':[], 'meuble et mobilier':[], 'sweat':[], 'chaussure basse':[], 'chaussette et collant':[], 'pull':[], 'basket et tennis':[], 'salopette':[], 'nuit':[], 'linge':[], 'bijoux':[], 'ceinture':[], 'repas':[], 'calecon et legging':[], 'hygiene et soin':[], 'veste':[]}


vector_response = api.apipost('training_similars', 'foqus', 'textile', 'testtwo-shop', tt, None)
