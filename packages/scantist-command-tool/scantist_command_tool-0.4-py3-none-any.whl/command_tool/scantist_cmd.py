...
from command_tool.utils.utils import logger, error_exit, config, ScanType, zip_folder, get_upload_zip_file
        ...
        if scan_type == ScanType.BINARY:
            ...
            if is_bom_detect:
                if not os.path.isdir(local_file):
                    error_exit("for bom_detect source code scan, please specify a valid folder path")
