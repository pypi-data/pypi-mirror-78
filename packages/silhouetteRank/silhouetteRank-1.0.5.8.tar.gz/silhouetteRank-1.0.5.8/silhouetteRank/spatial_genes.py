...
def rank_transform_matrix(mat, rbp_p = 0.99, reverse=True, matrix_type="dissim"):
	dim1 = mat.shape[0]
	dim2 = mat.shape[1]
...
def random_pattern(matrix=None, matrix_type="dissim", num_cell=None, sizes=None, trials_per_gene=100, seed=-1, outdir="result.5000", run_gpd=False):
	ncell = num_cell
...
def calc_silhouette_per_gene(genes=None, expr=None, matrix=None, matrix_type="dissim", examine_top=0.1, seed=-1):
	if genes is None or expr is None or matrix is None:
