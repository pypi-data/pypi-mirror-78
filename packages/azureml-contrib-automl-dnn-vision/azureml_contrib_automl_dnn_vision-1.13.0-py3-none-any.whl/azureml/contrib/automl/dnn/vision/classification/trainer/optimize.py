...
def _get_lr_scheduler(optimizer, settings):
    ...
    :type settings: dict
    :return: lr_scheduler
    :rtype: torch.optim.lr_scheduler object
    """
    step_size = settings[TrainingLiterals.STEP_LR_STEP_SIZE]
    gamma = settings[TrainingLiterals.STEP_LR_GAMMA]
