...
class AmlDatasetObjectDetectionWrapper(CommonObjectDetectionDatasetWrapper):
    ...
    @staticmethod
    def download_image_files(dataset_id, workspace, datasetclass=AmlDataset):
        """Download image files to a predefined local path.
        These files will be later used when AmlDatasetObjectDetectionWrapper is initiated.

        Please make sure that you set download_files to False in AmlDatasetObjectDetectionWrapper init
        ...
        image_column_name = AmlLabeledDatasetHelper.get_image_column_name(
            ds, AmlDatasetObjectDetectionWrapper.DATASET_IMAGE_COLUMN_NAME)
