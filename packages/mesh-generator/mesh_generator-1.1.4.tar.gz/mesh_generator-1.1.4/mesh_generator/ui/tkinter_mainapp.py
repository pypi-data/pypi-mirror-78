...
class MeshApp:
    ...
    def __init__(self, hdf_file_path, ui_session_data, save_mesh_file_path, UseExistingInput=False):
        ...
        tk.Label(self.leftFrame, text="ratio", relief=tk.RIDGE, bg='lightgray', bd=2). \
        ...
        self.rightFrame = VerticalScrolledFrame(root, relief=tk.SUNKEN, width=width_screen_pxl/4,
                                                height=height_screen_pxl/5) # width=465, height=600, borderwidth=2,
        self.rightFrame.grid(row=0, column=2, rowspan=2, sticky=tk.NSEW)

        # step 3- enter BG ratio
        tk.Label(self.rightFrame, text="Step 3: Input BG ratio:").grid(row=0, column=0, sticky=tk.W, pady=10)
        ...
        # enter FG ratio
        tk.Label(self.rightFrame, text="Input FG ratio:").grid(row=0, column=2, sticky=tk.E, pady=10, columnspan=2)
        ...
        tk.Label(self.rightFrame, text="Step 4: Get mesh results").grid(row=1, column=0, sticky=tk.W,
                                                                                pady=10)
        tk.Button(self.rightFrame, text='\u03B8 mesh results', command=self.get_theta_results). \
            grid(row=2, column=2, sticky=tk.W, columnspan=2, pady=10)
        tk.Button(self.rightFrame, text='\u03C6 mesh results', command=self.get_phi_results). \
            grid(row=3, column=2, sticky=tk.W, columnspan=2, pady=10)

        # step 5- radial mesh table
        tk.Label(self.rightFrame, text="Step 5: Input radial mesh segments").grid(row=4, column=0,
        ...
        tk.Button(self.rightFrame, text='r mesh results', command=self.get_radial_results). \
        ...
        tk.Button(self.bottomFrame, text="Save session", command=self.save_ui_session).grid(row=0, column=1)
        tk.Label(self.bottomFrame, text="vmin/vmax:").grid(row=0, column=9)
        ...
        tk.Button(self.bottomFrame, text="apply", command=self.apply_new_scale).grid(row=0, column=11)
