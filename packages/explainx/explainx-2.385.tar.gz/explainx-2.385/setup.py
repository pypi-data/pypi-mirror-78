...
setup(
  ...
  version = '2.385',      # Start with a small number and increase it with every change you make
  license='MIT',        # Chose a license from here: https://help.github.com/articles/licensing-a-repository
  description = 'Explainable AI Framework for Model Developers.',   # Give a short description about your library
  ...
  classifiers=[
    ...
    package_data={"explainx":["lib/*", "lib/apps/*","tutorials/*", "datasets/*", "lib/shap/*","lib/shap/plots/*", "lib/shap/plots/resources/*",
                              "lib/shap/explainers/*",
