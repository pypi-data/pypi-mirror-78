...
from awesome_panel_extensions.bokeh_extensions.fast.fast_textinput import (
...
See also https://explore.fast.design/components/fast-text-field.
    ...
    maxlength = param.Integer(default=None, doc="""The maximum length of the text string""",)
    minlength = param.Integer(default=None, doc="""The minimum length of the text string""",)
