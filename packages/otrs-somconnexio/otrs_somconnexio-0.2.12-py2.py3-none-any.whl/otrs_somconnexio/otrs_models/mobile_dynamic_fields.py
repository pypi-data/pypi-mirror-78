...
class MobileDynamicFields():
    ...
    def _df_previous_owner_name(self):
        return DynamicField(
            name="titular",
            value=self.eticom_contract.mobile_name or self.eticom_contract.party.name
        )

    def _df_previous_owner_first_name(self):
        return DynamicField(
            name="cognom1Titular",
            value=self.eticom_contract.mobile_surname or self.eticom_contract.party.first_name
        )
