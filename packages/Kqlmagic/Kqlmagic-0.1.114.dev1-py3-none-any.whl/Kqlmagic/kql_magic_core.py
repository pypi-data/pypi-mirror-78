...
class Kqlmagic_core(object):
    ...
    def _init_options(self):
        ...
        if app == "auto": # ELECTRON_RUN_AS_NODE
            ...
            if notebook_service_address.endswith(".ml.azure.com"):
                app = "azureml"
                ...
                app = "azurenotebook"
                _kernel_location = "remote"
            elif notebook_service_address.endswith(".azureml.net"):
        ...
        elif notebook_service_address.endswith(".ml.azure.com"):
            notebook_service_address = notebook_service_address.replace(".ml.azure.com", ".azureml.net")
        if notebook_service_address is not None:
            if notebook_service_address.search("://") < 0:
    ...
    def execute_bug_report_command(self, param:str=None, options:dict={}):
        ...
        for indent in [4, 3, 2, 1]:
            ...
            dummy = 'a'*(1 if options.get("auto_limit") is None else options.get("auto_limit"))
            potential_url = f"{Constants.MAGIC_ISSUES_REPOSITORY_URL}?title={encoded_title}&body={encoded_body}&dummy={dummy}"
