...
def project_number_input():
    project_number = input('How many GCP projects would you like to use? It allows to deploy your workflows to more than one project. Default 2\n')
...
def project_id_input(n):
    if n == 0:
        project = input(f'Enter a GCP project that would you use. Above is a list of available projects. If not provided default project from gcloud will be used.\n')
    else:
        project = input(f'Enter a #{n} GCP project that would you use. Above is a list of available projects. If not provided default project from gcloud will be used.\n')
    return project
...
def project_name_input():
    return input('Enter the project name. It will be used as a directory and dataflow bucket name.\n')
