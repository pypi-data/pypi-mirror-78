...
class PriorDIETClassifier(DIETClassifier):
    ...
    def train(
        ...
        **kwargs: Any,
        ...
        for message in training_data.training_examples:
            ...
            for idx, group_i in enumerate(prior_groups):
                if intent in group_i:
                    message.set(INTENT, f'prior_group_{idx}', add_to_output=True)
        ...
        print(training_data.training_examples[0].get(INTENT))
...
class PriorDIETClassifierExtended(DIETClassifier):
    ...
    def train(
        ...
        **kwargs: Any,
        ...
        print(training_data.training_examples[0].get(INTENT))
        print(training_data.intent_examples[0].get(INTENT))
    ...
    def process(self, message: Message, **kwargs: Any) -> None:
        ...
        prior_intent = message.get('prior_intent')
