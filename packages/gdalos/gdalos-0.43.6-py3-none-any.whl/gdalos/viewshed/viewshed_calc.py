...
def viewshed_calc_to_ds(vp_array,
    ...
    if input_ds is None and not files:
    ...
    if not files:
        ...
        for vp in vp_array:
            ...
            elif transform_coords_to_raster:
                vp.ox, vp.oy, _ = transform_coords_to_raster.TransformPoint(vp.ox, vp.oy)
