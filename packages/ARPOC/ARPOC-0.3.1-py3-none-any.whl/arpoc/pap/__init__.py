...
The PAP allows you to display the currently loaded access control entities.
It also allows to test specific rules and visualizes the result of the evaluation.
