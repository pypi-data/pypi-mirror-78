...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'consul', '2.5.0-alpha.1599152382+1e5afe0b'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource consul 2.5.0-alpha.1599152382+1e5afe0b`
                """)
            else:
                raise
