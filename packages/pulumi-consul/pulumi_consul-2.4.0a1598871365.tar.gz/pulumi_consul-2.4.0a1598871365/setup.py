...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'consul', '2.4.0-alpha.1598871365+6b13a1ba'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource consul 2.4.0-alpha.1598871365+6b13a1ba`
                """)
            else:
                raise
