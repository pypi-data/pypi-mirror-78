...
import argparse
from extended import kaggle_api
...
def create_parser():
    ...
    parser.add_argument('-v',
                        '--version',
                        action='version',
                        version='Kaggle API ' + kaggle_api.__version__)
...
def parse_competitions(subparsers):
    ...
    parser_competitions_list.set_defaults(
        func=kaggle_api.competitions_list_cli)
    ...
    parser_competitions_files.set_defaults(
        func=kaggle_api.competition_list_files_cli)
    ...
    parser_competitions_download.set_defaults(
        func=kaggle_api.competition_download_cli)
    ...
    parser_competitions_submit.set_defaults(
        func=kaggle_api.competition_submit_cli)
    ...
    parser_competitions_submissions.set_defaults(
        func=kaggle_api.competition_submissions_cli)
    ...
    parser_competitions_leaderboard.set_defaults(
        func=kaggle_api.competition_leaderboard_cli)
...
def parse_datasets(subparsers):
    ...
    parser_datasets_list.set_defaults(func=kaggle_api.dataset_list_cli)
    ...
    parser_datasets_files.set_defaults(func=kaggle_api.dataset_list_files_cli)
    ...
    parser_datasets_download.set_defaults(func=kaggle_api.dataset_download_cli)
    ...
    parser_datasets_create.set_defaults(func=kaggle_api.dataset_create_new_cli)
    ...
    parser_datasets_version.set_defaults(
        func=kaggle_api.dataset_create_version_cli)
    ...
    parser_datasets_init.set_defaults(func=kaggle_api.dataset_initialize_cli)
    ...
    parser_datasets_metadata.set_defaults(func=kaggle_api.dataset_metadata_cli)
    ...
    parser_datasets_status.set_defaults(func=kaggle_api.dataset_status_cli)
...
def parse_kernels(subparsers):
    ...
    parser_kernels_list.set_defaults(func=kaggle_api.kernels_list_cli)
    ...
    parser_kernels_init.set_defaults(func=kaggle_api.kernels_initialize_cli)
    ...
    parser_kernels_push.set_defaults(func=kaggle_api.kernels_push_cli)
    ...
    parser_kernels_pull.set_defaults(func=kaggle_api.kernels_pull_cli)
    ...
    parser_kernels_output.set_defaults(func=kaggle_api.kernels_output_cli)
    ...
    parser_kernels_status.set_defaults(func=kaggle_api.kernels_status_cli)
...
def parse_config(subparsers):
    ...
    parser_config_view.set_defaults(func=kaggle_api.print_config_values)
    ...
    parser_config_set.set_defaults(func=kaggle_api.set_config_value)
    ...
    parser_config_unset_required.add_argument('-n',
                                              ...
                                              required=True,
                                              help=Help.param_config_name)
    parser_config_unset.set_defaults(func=kaggle_api.unset_config_value)
...
class Help(object):
    ...
    competitions_choices = [
        'list', 'get', 'files', 'download', 'submit', 'submissions',
        'leaderboard'
    ]
    datasets_choices = [
    ...
    command_competitions_get = 'Get information about a competition'
