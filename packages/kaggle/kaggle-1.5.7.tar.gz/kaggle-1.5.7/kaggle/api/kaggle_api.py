...
class KaggleApi(object):
    ...
    def competitions_data_download_files(self, id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.competitions_data_download_files_with_http_info(
                id, **kwargs)  # noqa: E501
        else:
            (data) = self.competitions_data_download_files_with_http_info(
                id, **kwargs)  # noqa: E501
            return data

    def competitions_data_download_files_with_http_info(
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError("Got an unexpected keyword argument '%s'"
                                " to method competitions_data_download_files" %
                                key)
            params[key] = val
        del params['kwargs']
        ...
        if ('id' not in params or params['id'] is None):
            raise ValueError(
                "Missing the required parameter `id` when calling `competitions_data_download_files`"
            )  # noqa: E501
