...
def CompleteRun():
    ...
    Sw = MinMaxSweep(a, 6)
    MagnetName = 'MCBXV_CopperWedges_ThCool'
    ...
    Sw.addQuenchSweep("tStartQuench", [[1, 890],[393,1282],[1, 890],[393,1282],[1, 890],[393,1282],[1, 890],[393,1282]],
    ...
    RunSimulations(ledetFolder, ledetExe, 'MCBXV_CopperWedges_ThCool', RunSimulations=True)
    ...
    # EvaluateSimulations('C:\\cernbox\\LEDET\\LEDET\\MCBXV_CopperWedges_ThCool\\Output\\Txt Files',
