...
random_spell = FlexCat({
    ...
    "level_1": (
        ...
        "Color Spray", "Command", "Comprehend Languages",
        ...
        "Guiding Bolt", "Healing Word", "Heroism", "Identify",
        "Illusory Script", "Inflict Wounds", "Jump",
        "Longstrider", "Mage Armor", "Magic Missile",
        "Protection from Evil and Good", "Purify Food and Drink",
        "Ray of Sickness", "Sanctuary", "Shield", "Shield of Faith",
    ...
    "level_2": (
        ...
        "Calm Emotions", "Cloud of Daggers", "Continual Flame",
        "Crown of Madness", "Darkness", "Darkvision",
        "Detect Thoughts", "Enhance Ability", "Enlarge/Reduce", "Enthrall",
        "Find Traps", "Flaming Sphere",
        "Gentle Repose", "Gust of Wind", "Heat Metal", "Hold Person",
        "Invisibility", "Knock",
        "Lesser Restoration", "Levitate", "Locate Animals or Plants",
        "Locate Object", "Magic Mouth",
        ...
        "Spider Climb",
        "Spiritual Weapon", "Suggestion", "Warding Bond", "Web",
        "Zone of Truth",
    ),
    "level_3": (
        "Animate Dead", "Beacon of Hope", "Bestow Curse", "Blink",
        "Clairvoyance", "Counterspell",
        "Create Food and Water", "Daylight", "Dispel Magic", "Fear",
        "Feign Death", "Fireball", "Fly",
        "Gaseous Form", "Glyph of Warding", "Haste", "Hypnotic Pattern",
        "Leomund's Tiny Hut", "Lightning Bolt",
        "Magic Circle", "Major Image", "Mass Healing Word", "Meld into Stone",
        "Nondetection", "Phantom Steed",
        "Plant Growth", "Protection from Energy", "Remove Curse", "Revivify",
        "Sending", "Sleet Storm", "Slow",
        "Speak with Dead", "Speak with Plants", "Spirit Guardians",
        "Stinking Cloud", "Tongues", "Vampiric Touch",
        "Water Breathing", "Water Walk",
    ),
    "level_4": (
        "Arcane Eye", "Banishment", "Blight", "Compulsion", "Confusion",
        "Conjure Minor Elementals",
        "Control Water", "Death Ward", "Dimension Door", "Divination",
        "Evard's Black Tentacles", "Fabricate",
        "Faithful Hound", "Fire Shield", "Freedom of Movement",
    ...
    "level_5": (
        "Animate Objects", "Awaken", "Bigby's Hand", "Cloudkill",
        "Commune Contagion", "Cone of Cold",
    ...
    "level_6": (
        ...
        "Disintegrate", "Drawmij's Instant Summons", "Eyebite", "Find the Path",
        "Flesh to Stone",
        "Forbiddance", "Harm", "Globe of Invulnerability", "Guards and Wards",
        "Heal", "Heroes' Feast", "Magic Jar",
        "Mass Suggestion", "Move Earth", "Otiluke's Freezing Sphere",
        "Otto's Irresistible Dance", "Planar Ally",
        "Programmed Illusion", "Sunbeam", "True Seeing", "Wall of Ice",
        "Word of Recall",
    ),
    "level_7": (
        "Conjure Celestial", "Delayed Blast", "Divine Word", "Etherealness",
    ...
    "level_8": (
        ...
        "Earthquake", "Feeblemind", "Glibness", "Holy Aura", "Incendiary Cloud",
        "Maze", "Mind Blank",
