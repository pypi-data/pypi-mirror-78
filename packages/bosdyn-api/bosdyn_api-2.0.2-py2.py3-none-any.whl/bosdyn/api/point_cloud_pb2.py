...
_GETPOINTCLOUDRESPONSE_STATUS = _descriptor.EnumDescriptor(
  name='Status',
  full_name='bosdyn.api.GetPointCloudResponse.Status',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_sym_db.RegisterEnumDescriptor(_GETPOINTCLOUDRESPONSE_STATUS)
...
_GETPOINTCLOUDRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='status', full_name='bosdyn.api.GetPointCloudResponse.status', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='point_cloud', full_name='bosdyn.api.GetPointCloudResponse.point_cloud', index=2,
...
_GETPOINTCLOUDRESPONSE.fields_by_name['status'].enum_type = _GETPOINTCLOUDRESPONSE_STATUS
_GETPOINTCLOUDRESPONSE.fields_by_name['point_cloud'].message_type = _POINTCLOUD
_GETPOINTCLOUDRESPONSE_STATUS.containing_type = _GETPOINTCLOUDRESPONSE
