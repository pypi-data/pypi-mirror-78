...
_LOCALIZATION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='timestamp', full_name='bosdyn.api.graph_nav.Localization.timestamp', index=2,
