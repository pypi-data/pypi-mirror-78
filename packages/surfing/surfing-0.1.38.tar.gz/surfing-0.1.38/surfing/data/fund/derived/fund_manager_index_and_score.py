...
class FundManagerIndexAndScore:
    ...
    def init(self, start_date: str, end_date: str):
        ...
        self._scale = FundManagerIndexAndScore._clean_scale(self._scale, self._td).loc[start_date:end_date]
    ...
    def _clean_scale(scale: pd.DataFrame, td: pd.DataFrame) -> pd.DataFrame:
        ...
        scale = scale.reindex(scale.index.union(td.datetime.array))
        scale = scale.loc[scale.index.intersection(td.datetime.array), :]
        return scale.ffill().dropna(how='all').dropna(how='all', axis=1)
    ...
    def process(self, start_date: str, end_date: str, eval_date: str, eval_start_date: str) -> List[str]:
        ...
        try:
            ...
            # print(self._df_list)
            # 暂时没有往DB里更新的逻辑
            # self._data_helper._upload_derived(self._result, __table__.name)
...
if __name__ == '__main__':
    ...
    fmis.process(start_date='2005-01-01', end_date='2020-08-14', eval_date='2020-08-14', eval_start_date='2005-01-01')
