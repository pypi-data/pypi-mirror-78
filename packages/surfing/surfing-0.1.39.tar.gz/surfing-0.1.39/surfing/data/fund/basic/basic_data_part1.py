...
class BasicDataPart1:
    ...
    def fund_info_from_raw(self, fund_id_list: Set[str], benchmark_profile: pd.Series):
        ...
        # 只处理非场内基金
        fund_id_list = [one for one in fund_id_list if '.OF' in one]
        # 获取raw中的基金基础信息
    ...
    def index_price(self, start_date, end_date):
        try:
            ...
            trading_day_df = BasicDataApi().get_trading_day_list(start_date.start_date.strftime('%Y%m%d'), end_date)
            trading_day_df = trading_day_df[trading_day_df.datetime <= raw_start_date_dt]
    ...
    def fund_hold_asset(self, start_date: str, end_date: str):
        ...
        em_hold_asset = em_hold_asset[em_hold_asset.CODES.str.contains('.OF')]
    ...
    def fund_hold_industry(self, end_date: str):
        ...
        em_hold_industry = em_hold_industry[em_hold_industry.CODES.str.contains('.OF')]
