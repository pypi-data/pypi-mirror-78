...
class MrsSpec:
    ...
    def interp(self, wave_new=None, rv=0, npix_cushion=50, cr=True):
        wave_obs = me.wave[npix_cushion:npix_cushion]
        flux_obs = debad(me.wave_B, me.flux_B, nsigma=(4, 8), maxiter=5)[npix_cushion:npix_cushion]
        flux_err = me.flux_norm_err_B[50:-50]

        flux_new = np.interp(wave_new, self.wave[npix_cushion:-npix_cushion] / (1 + rv / SOL_kms),
                             self.flux[npix_cushion:-npix_cushion])
        flux_err_new = np.interp(wave_new, self.wave[npix_cushion:-npix_cushion] / (1 + rv / SOL_kms),
                                 self.flux_err[npix_cushion:-npix_cushion])
        mask_new = np.interp(wave_new, self.wave[npix_cushion:-npix_cushion] / (1 + rv / SOL_kms),
                             self.flux_err[npix_cushion:-npix_cushion]) > 0
        return flux_new, flux_err_new, mask_new
