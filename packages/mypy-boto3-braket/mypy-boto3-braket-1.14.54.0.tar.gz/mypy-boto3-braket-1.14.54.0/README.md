...
[boto3.Braket 1.14.54](https://boto3.amazonaws.com/v1/documentation/api/1.14.54/reference/services/braket.html#Braket) service
...
`mypy_boto3_braket` and other installed services.
...
session_client = boto3.Session().client("braket")
```
