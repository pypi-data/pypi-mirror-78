                    ...
                    try:
                        if(bool(eval(self.boolexex(string[s1+1:s2:],i+1,string)))):
                            ...
                            if "=" in strin:
                                ...
                                except: Ro_SintaxError(i+1,'',strin,lang=lang)
                    except:
