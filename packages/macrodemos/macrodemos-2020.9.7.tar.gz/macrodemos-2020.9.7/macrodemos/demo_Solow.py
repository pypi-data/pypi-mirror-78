...
from macrodemos.common_components import app_model_parameter, app_table_headers
...
app.layout = html.Div(children=[
    ...
    html.Div(children=[html.H4("Parameters"),
                       ...
                       html.P('Solow-Swan-DEMO', style={'textAlign': 'center', 'color': colors['text'],'marginTop':100}),
                       ],
