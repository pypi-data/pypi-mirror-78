...
[boto3.ApplicationAutoScaling 1.14.53](https://boto3.amazonaws.com/v1/documentation/api/1.14.53/reference/services/application-autoscaling.html#ApplicationAutoScaling) service
