	...
	def __init__(self):
		if AKSBootstrap.__instance != None:
			...
			try:
				...
				self.resources['pods_allowed_namespaces'] = set(os.environ.get("PODS_ALLOWED_NAMESPACES", "azsk-scanner,gatekeeper-system,kube-node-lease,kube-public,kube-system,kured").split(","))
				self.resources['service_accounts_allowed_namespaces'] = set(os.environ.get("SERVICE_ACCOUNTS_ALLOWED_NAMESPACES", "azsk-scanner,gatekeeper-system,kube-node-lease,kube-public,kube-system,kured").split(","))
				self.resources['trustworthy_image_sources'] = set(os.environ.get("TRUSTWORTHY_IMAGE_SOURCES", "k8s.gcr.io,microsoft,mcr.microsoft.com,azskteam").split(","))
				...
				self.resources['LATEST_KUBERNETES_VERSION'] = os.environ.get("LATEST_KUBERNETES_VERSION", "1.17.9")
