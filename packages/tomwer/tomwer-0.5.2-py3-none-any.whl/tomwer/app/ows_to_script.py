...
def _convert(scheme, output_file, overwrite):
    ...
    _logger.info('translation finished. You can execute python {} [scan path] [[--entry]]'.format(output_file))


def _dump_info_generation():
    return "# This file has been generated automatically using \n" \
           "# pypushflow {} and tomwer {}\n".format(pypushflow.version.version,
                                                    tomwer.version.version)
...
def main(argv):
    ...
    _convert(scheme=scheme, output_file=options.output_file,
