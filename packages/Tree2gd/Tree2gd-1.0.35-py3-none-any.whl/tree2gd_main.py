...
def main():
    ...
    if '5' in args.step:
        ...
        ParaAT_aligncmd=cf.get("software", "ParaAT_aligncmd") if cf.has_option("software", "ParaAT_aligncmd") and cf.get("software", "ParaAT_aligncmd")!="" else os.sep.join([home_dir,"tree2gd","software", "muscle"])
