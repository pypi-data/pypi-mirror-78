...
class SwapService:
    ...
    def _load_gcp_data_parameters(self, parsed_token):
        ...
        return GCSDataDetail(name=name, url=url, size=size, custom_metadata=custom_metadata)
    ...
    def _load_cdf_data_parameters(self, parsed_token):
        ...
        return CDFDataDetail(id=id, crs=crs, survey_id=survey_id, custom_metadata=custom_metadata)
