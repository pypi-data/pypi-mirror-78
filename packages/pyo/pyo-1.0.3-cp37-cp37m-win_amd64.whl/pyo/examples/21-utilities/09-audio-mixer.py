...
low = SfPlayer("../snds/flute.aif", speed=0.5, loop=True, mul=.3)
mid = SfPlayer("../snds/flute.aif", speed=.75, loop=True, mul=.3)
hig = SfPlayer("../snds/flute.aif", speed=1.0, loop=True, mul=.3)
...
secondAbove = Harmonizer(mm[2], transpo=2, feedback=.25, add=mm[2]).out()
...
mm.setAmp(vin=0, vout=0, amp=.25)
mm.setAmp(vin=1, vout=2, amp=.25)
