...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'digitalocean', '2.7.0-alpha.1598868800+bb71cf84'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource digitalocean 2.7.0-alpha.1598868800+bb71cf84`
                """)
            else:
                raise
