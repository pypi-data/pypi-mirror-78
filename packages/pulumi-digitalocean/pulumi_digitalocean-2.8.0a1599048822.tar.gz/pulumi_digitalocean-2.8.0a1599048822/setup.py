...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'digitalocean', '2.8.0-alpha.1599048822+8febd1b1'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource digitalocean 2.8.0-alpha.1599048822+8febd1b1`
                """)
            else:
                raise
