...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'digitalocean', '2.9.0-alpha.1599152608+0e3112aa'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource digitalocean 2.9.0-alpha.1599152608+0e3112aa`
                """)
            else:
                raise
