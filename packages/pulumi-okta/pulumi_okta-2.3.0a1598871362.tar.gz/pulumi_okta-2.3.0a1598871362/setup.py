...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'okta', '2.3.0-alpha.1598871362+c4c3a1bc'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource okta 2.3.0-alpha.1598871362+c4c3a1bc`
                """)
            else:
                raise
