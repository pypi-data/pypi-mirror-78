...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'okta', '2.3.0-alpha.1598637750+aff7b1f1'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource okta 2.3.0-alpha.1598637750+aff7b1f1`
                """)
            else:
                raise
