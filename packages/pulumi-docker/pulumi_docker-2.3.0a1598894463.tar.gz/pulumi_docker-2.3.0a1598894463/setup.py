...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'docker', '2.3.0-alpha.1598894463+537e5f27'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource docker 2.3.0-alpha.1598894463+537e5f27`
                """)
            else:
                raise
