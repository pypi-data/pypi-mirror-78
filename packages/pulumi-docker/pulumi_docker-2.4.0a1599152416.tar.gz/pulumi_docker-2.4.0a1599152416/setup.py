...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'docker', '2.4.0-alpha.1599152416+e604aef7'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource docker 2.4.0-alpha.1599152416+e604aef7`
                """)
            else:
                raise
