...
class getDiffResultsHash_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i219 in range(_size215):
                        ...
                        self.reportHashes.append(_elem220)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i225 in range(_size221):
                        ...
                        self.skipDetectionStatuses.append(_elem226)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.reportHashes is not None:
            ...
            for iter228 in self.reportHashes:
        ...
        if self.skipDetectionStatuses is not None:
            ...
            for iter229 in self.skipDetectionStatuses:
...
class getLinesInSourceFileContents_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i283 in range(_size279):
                        _elem284 = LinesInFilesRequested()
                        _elem284.read(iprot)
                        self.linesInFilesRequested.append(_elem284)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.linesInFilesRequested is not None:
            ...
            for iter285 in self.linesInFilesRequested:
                iter285.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.encoding is not None:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter300, viter301 in self.success.items():
                oprot.writeI64(kiter300)
                oprot.writeMapBegin(TType.I64, TType.STRING, len(viter301))
                for kiter302, viter303 in viter301.items():
                    oprot.writeI64(kiter302)
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter371, viter372 in self.success.items():
                oprot.writeI32(kiter371)
                oprot.writeI64(viter372)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.requestError is not None:
            oprot.writeFieldBegin('requestError', TType.STRUCT, 1)
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i400 in range(_size396):
                        _key401 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
...
class getCheckerCounts_args(object):
    ...
    def write(self, oprot):
        ...
        if self.runIds is not None:
            oprot.writeFieldBegin('runIds', TType.LIST, 1)
            oprot.writeListBegin(TType.I64, len(self.runIds))
            for iter411 in self.runIds:
                oprot.writeI64(iter411)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.reportFilter is not None:
            oprot.writeFieldBegin('reportFilter', TType.STRUCT, 2)
...
class getSourceComponents_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i453 in range(_size449):
                        _elem454 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.sourceComponentFilter.append(_elem454)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.sourceComponentFilter is not None:
            ...
            for iter455 in self.sourceComponentFilter:
...
class getMissingContentHashes_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i467 in range(_size463):
                        _elem468 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.fileHashes.append(_elem468)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.fileHashes is not None:
            ...
            for iter469 in self.fileHashes:
                oprot.writeString(iter469.encode('utf-8') if sys.version_info[0] == 2 else iter469)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i474 in range(_size470):
                        _elem475 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for iter476 in self.success:
                oprot.writeString(iter476.encode('utf-8') if sys.version_info[0] == 2 else iter476)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.requestError is not None:
            oprot.writeFieldBegin('requestError', TType.STRUCT, 1)
...
class massStoreRun_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i481 in range(_size477):
                        ...
                        self.trimPathPrefixes.append(_elem482)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
    ...
    def write(self, oprot):
        ...
        if self.trimPathPrefixes is not None:
            ...
            for iter483 in self.trimPathPrefixes:
