...
set(GLPK_REQUESTED_VERSION
  "4.65"
  CACHE
  PATH
  "Version found must be above this version number"
  )
...
if (GLPK_INCLUDE_DIR AND GLPK_LIBRARY)
  ...
  string(REGEX
    MATCH "define[ ]+GLP_MAJOR_VERSION[ ]+[0-9]+"
    GLPK_MAJOR_VERSION_LINE "${GLPK_GLPK_H}"
    )
  string(REGEX
    REPLACE "define[ ]+GLP_MAJOR_VERSION[ ]+([0-9]+)" "\\1"
    GLPK_VERSION_MAJOR "${GLPK_MAJOR_VERSION_LINE}"
    )

  string(REGEX
    MATCH "define[ ]+GLP_MINOR_VERSION[ ]+[0-9]+"
    GLPK_MINOR_VERSION_LINE "${GLPK_GLPK_H}"
    )
  string(REGEX
    REPLACE "define[ ]+GLP_MINOR_VERSION[ ]+([0-9]+)" "\\1"
...
if (GLPK_FOUND)
  set(GLPK_INCLUDE_DIR ${GLPK_INCLUDE_DIR})
  set(GLPK_LIBRARY ${GLPK_LIBRARY})
