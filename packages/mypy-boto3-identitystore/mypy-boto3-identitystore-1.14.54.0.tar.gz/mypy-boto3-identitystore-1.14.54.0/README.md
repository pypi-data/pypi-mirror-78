...
[boto3.IdentityStore 1.14.54](https://boto3.amazonaws.com/v1/documentation/api/1.14.54/reference/services/identitystore.html#IdentityStore) service
...
`mypy_boto3_identitystore` and other installed services.
...
session_client = boto3.Session().client("identitystore")
```
