...
setup(
    ...
    description="Type annotations for boto3.IdentityStore 1.14.53 service, generated by mypy-boto3-buider 2.4.0",
    classifiers=[
    ...
    package_data={"mypy_boto3_identitystore": ["py.typed"]},
    python_requires=">=3.6",
    project_urls={
