...
def main():
    ...
    parser.add_argument("-f", "--format", help="output format - one of xschem, eeschema", type=str)
    parser.add_argument("-d", "--depth", help="depth to unpack subcircuits", default=0, type=str)
