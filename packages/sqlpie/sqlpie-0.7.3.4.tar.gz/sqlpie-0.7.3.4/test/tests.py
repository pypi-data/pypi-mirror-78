...
class TestClient(unittest.TestCase):
  ...
  def test_model_key_names(self):
  	self.assertEqual(list(example_model.rendered_model.keys()), ['example_model.example_3', 'example_model_staging.example_1', 'example_model.example_2'])
  ...
  def test_file_path_index(self):
    file_path_index = {'./models/model_2/example_1.sql': 'model_2.example_1', './models/model_2/enrich_example_1.sql': 'custom_staging_schema.enrich_example_1', './models/model_with_empty_config/query_1.sql': 'model_with_empty_config.query_1', './models/example_model/example_3.sql': 'example_model.example_3', './models/example_model/example_1_staging.sql': 'example_model_staging.example_1', './models/example_model/example_2.sql': 'example_model.example_2'}
