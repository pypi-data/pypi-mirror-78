# Generated by Django 3.0.8 on 2020-09-01 10:36

import django.core.validators
from django.db import migrations, models
import django.db.models.deletion
import django_celery_beat.validators
import opstasks.models
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('args', models.TextField(blank=True, help_text='传递给任务的位置参数, Json格式', validators=[opstasks.models.validate_tasks_args], verbose_name='位置参数')),
                ('kwargs', models.TextField(blank=True, help_text='传递给任务的关键字参数, Json格式', validators=[opstasks.models.validate_tasks_kwargs], verbose_name='任务参数')),
                ...
                ('clocked', models.ForeignKey(blank=True, help_text='注:仅能设置一种调度方式,请将其余计划留空.', null=True, on_delete=django.db.models.deletion.CASCADE, to='opstasks.ClockedSchedule', verbose_name='Clocked计划')),
                ('crontab', models.ForeignKey(blank=True, help_text='注:仅能设置一种调度方式,请将其余计划留空.', null=True, on_delete=django.db.models.deletion.CASCADE, to='opstasks.CrontabSchedule', verbose_name='Crontab计划')),
                ('interval', models.ForeignKey(blank=True, help_text='注:仅能设置一种调度方式,请将其余计划留空.', null=True, on_delete=django.db.models.deletion.CASCADE, to='opstasks.IntervalSchedule', verbose_name='Interval计划')),
                ('registered_task', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='TASK', to='opstasks.Task', verbose_name='已注册任务')),
                ('solar', models.ForeignKey(blank=True, help_text='注:仅能设置一种调度方式,请将其余计划留空.', null=True, on_delete=django.db.models.deletion.CASCADE, to='opstasks.SolarSchedule', verbose_name='Solar计划')),
            ],
            options={
                'verbose_name': '定时任务',
