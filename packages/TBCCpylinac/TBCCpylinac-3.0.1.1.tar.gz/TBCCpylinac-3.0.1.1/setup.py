...
setup(
    ...
    author='James Kerns, Tom Baker Cancer Centre',
    author_email='joseph.madamesila@albertahealthservices.ca',
    description='A modified version of Pylinac made specifically for TBCC. Pylinac is a toolkit for performing TG-142 QA-related tasks on a linear accelerator',
