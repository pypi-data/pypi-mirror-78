...
from ..utils import encode_utf8_if_py2, deprecated, get_id_from_response
from .api_object import APIObject
from .prediction_explanations import (prediction_values_trafaret,
...
class ReasonCodes(APIObject):
    ...
    @deprecated('2.12', '2.15', 'Please use the PredictionExplanations interface '
                                'instead of the ReasonCodes interface.')
