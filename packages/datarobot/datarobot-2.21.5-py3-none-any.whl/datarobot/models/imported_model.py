...
class ImportedModel(APIObject):
    ...
    def __init__(self, id, imported_at=None, model_id=None, target=None, featurelist_name=None,
                 dataset_name=None, model_name=None, project_id=None, version=None, note=None,
                 origin_url=None, imported_by_username=None, project_name=None,
                 created_by_username=None, created_by_id=None, imported_by_id=None,
                 display_name=None):
    ...
    def create(cls, path):
        ...
        response = cls._client.build_request_with_file('post', cls._root_path, name,
                                                       file_path=path)
        async_loc = response.headers['Location']
        imported_model_loc = wait_for_async_resolution(cls._client, async_loc)
