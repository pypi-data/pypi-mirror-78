        ...
        "data": [
            {
                ...
                "customModelVersion": {
                    "id": "5cf4d3f5f930e26daac18acv",
                    "label": "cmv",
                },
                "executionEnvironment": {
                    "id": "5cf4d3f5f930e26daac18aee",
                    "name": "ee",
                },
                "executionEnvironmentVersion": {
                    "id": "5cf4d3f5f930e26daac18aev",
                    "label": "eev",
                },
            ...
            },
            {
                ...
                "customModelVersion": {
                    "id": "5cf4d3f5f930e26daac18bcv",
                    "label": "cmv n2",
                },
                "executionEnvironment": {
                    "id": "5cf4d3f5f930e26daac18bee",
                    "name": "ee n2",
                },
                "executionEnvironmentVersion": {
...
def assert_image(image, image_json):
    ...
    assert (
        image.custom_model_version["label"] == image_json["customModelVersion"]["label"]
    )
    assert image.execution_environment["id"] == image_json["executionEnvironment"]["id"]
    assert (
        image.execution_environment["name"] == image_json["executionEnvironment"]["name"]
    )
    ...
    if image.latest_test is None:
        ...
        assert (
            image.latest_test["completed_at"] == image_json["latestTest"]["completedAt"]
        )
...
def test_list_images_multiple_pages(mocked_images, make_images_url):
    ...
    for image, mocked_image in zip(
        images, mocked_images["data"] + mocked_images_2nd["data"]
    ):
        assert_image(image, mocked_image)
...
def test_list_filter_build_status(mocked_image, make_images_url, filter, property_key):
    ...
    mock_get_response(
        url, {"count": 1, "next": None, "previous": None, "data": [mocked_image]}
    )
