...
class ExternalConfusionChart(APIObject):
    ...
    _single_chart_path = 'projects/{project_id}/models/{model_id}/'\
                         'datasetConfusionCharts/{dataset_id}/'
    _metadata_path = 'projects/{project_id}/models/{model_id}/'\
                     'datasetConfusionCharts/{dataset_id}/metadata/'
    _converter = t.Dict({
    ...
    def __repr__(self):
        return encode_utf8_if_py2(
            u'ExternalConfusionChart(dataset_id={}, classes={})'.format(self.dataset_id,
                                                                        self.classes))
    ...
    def get(cls, project_id, model_id, dataset_id):
        ...
        url = cls._single_chart_path.format(project_id=project_id, model_id=model_id,
                                            dataset_id=dataset_id)

        confusion_chart = cls._client.get(url).json()
        metadata = cls._get_metadata(project_id=project_id, model_id=model_id,
                                     dataset_id=dataset_id)
    ...
    def _get_metadata(cls, project_id, model_id, dataset_id):
        ...
        """
        url = cls._metadata_path.format(project_id=project_id, model_id=model_id,
                                        dataset_id=dataset_id)
