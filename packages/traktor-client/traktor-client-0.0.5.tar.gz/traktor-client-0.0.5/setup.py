...
def get_version():
    ...
    version_py = Path(__file__).parent / "traktor_client" / "version.py"
...
setup(
    ...
    description="Python client for the Traktor web api.",
    long_description=io.open("README.md", "r", encoding="utf-8").read(),
    long_description_content_type="text/markdown",
    url="https://github.com/alefnula/traktor-client",
    ...
    entry_points="""
        [console_scripts]
        traktor-client=traktor_client.commands:app
    """,
)
