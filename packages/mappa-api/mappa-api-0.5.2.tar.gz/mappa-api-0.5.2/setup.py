...
_name, _version, _description, _author, _author_email = get_definitions(
    os.path.join('mappa_api', '__init__.py'),
    'tool_name',
    'version',
    'description',
    'author',
...
setup(
    ...
    url='https://github.com/guionardo/mappa-api',
    keywords='escoteiros scouts mappa',
    project_urls={
        "Documentation": "https://github.com/guionardo/mappa-api/wiki",
        "Source": "https://github.com/guionardo/mappa-api",
    },
    author=_author,
