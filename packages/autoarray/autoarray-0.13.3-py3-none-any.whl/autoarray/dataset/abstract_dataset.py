...
class AbstractSettingsMaskedDataset:
    ...
    def grid_tag_no_inversion(self):
        ...
        return (
            "__"
            + conf.instance.settings_tag.get("dataset", "grid")
            + "_"
    ...
    def grid_tag_with_inversion(self):
        ...
        return (
            ...
            + self.grid_pixel_scales_interp_tag
            + "_"
            + conf.instance.settings_tag.get("dataset", "grid_inversion")
            + "_"
    ...
    def grid_sub_size_tag(self):
        ...
        if not self.grid_class is grids.Grid:
            return ""
        return conf.instance.settings_tag.get("dataset", "sub_size") + "_" + str(self.sub_size)
    ...
    def grid_fractional_accuracy_tag(self):
        ...
        if not self.grid_class is grids.GridIterate:
            return ""
        return (
            conf.instance.settings_tag.get("dataset", "fractional_accuracy")
            + "_"
    ...
    def signal_to_noise_limit_tag(self):
        ...
        return (
            "__"
            + conf.instance.settings_tag.get("dataset", "signal_to_noise_limit")
            + "_"
