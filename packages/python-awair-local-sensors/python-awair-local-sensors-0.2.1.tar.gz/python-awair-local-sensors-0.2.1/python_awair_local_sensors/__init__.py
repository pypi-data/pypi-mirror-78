...
from python_awair_local_sensors import const
from python_awair_local_sensors.auth import AccessTokenAuth, AwairAuth
from python_awair_local_sensors.client import AwairClient
...
from python_awair_local_sensors.user import AwairUser
