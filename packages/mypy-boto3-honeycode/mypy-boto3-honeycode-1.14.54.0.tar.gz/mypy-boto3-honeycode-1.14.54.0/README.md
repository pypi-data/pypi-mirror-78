...
[boto3.Honeycode 1.14.54](https://boto3.amazonaws.com/v1/documentation/api/1.14.54/reference/services/honeycode.html#Honeycode) service
...
`mypy_boto3_honeycode` and other installed services.
...
session_client = boto3.Session().client("honeycode")
```
