...
class Fcoe(object):
    ...
    Args
    ----
    - flow_control_type (Union[none, ieee_802_1qbb, ieee_802_3x]): The type of fcoe flow control. If ieee_802_3x is selected then none of the pfc properties will apply. If none is selected then none of the fcoe properties will apply
    - pfc_delay_quanta (int): TBD
    - pfc_delay_time (Union[float, int]): TBD
    - pfc_class_0 (list[Union[none, zero, one, two, three, four, five, size, seven]]): TBD
    - pfc_class_1 (list[Union[none, zero, one, two, three, four, five, size, seven]]): TBD
    - pfc_class_2 (list[Union[none, zero, one, two, three, four, five, size, seven]]): TBD
    - pfc_class_3 (list[Union[none, zero, one, two, three, four, five, size, seven]]): TBD
    - pfc_class_4 (list[Union[none, zero, one, two, three, four, five, size, seven]]): TBD
    - pfc_class_5 (list[Union[none, zero, one, two, three, four, five, size, seven]]): TBD
    - pfc_class_6 (list[Union[none, zero, one, two, three, four, five, size, seven]]): TBD
    - pfc_class_7 (list[Union[none, zero, one, two, three, four, five, size, seven]]): TBD
    """
    def __init__(self, flow_control_type='none', pfc_delay_quanta=None, pfc_delay_time=None, pfc_class_0=[], pfc_class_1=[], pfc_class_2=[], pfc_class_3=[], pfc_class_4=[], pfc_class_5=[], pfc_class_6=[], pfc_class_7=[]):
        ...
        if isinstance(pfc_delay_time, (float, int, type(None))) is True:
            self.pfc_delay_time = pfc_delay_time
        else:
            raise TypeError('pfc_delay_time must be an instance of (float, int, type(None))')
        if isinstance(pfc_class_0, (list, type(None))) is True:
            self.pfc_class_0 = pfc_class_0
        else:
            raise TypeError('pfc_class_0 must be an instance of (list, type(None))')
        if isinstance(pfc_class_1, (list, type(None))) is True:
            self.pfc_class_1 = pfc_class_1
        else:
            raise TypeError('pfc_class_1 must be an instance of (list, type(None))')
        if isinstance(pfc_class_2, (list, type(None))) is True:
            self.pfc_class_2 = pfc_class_2
        else:
            raise TypeError('pfc_class_2 must be an instance of (list, type(None))')
        if isinstance(pfc_class_3, (list, type(None))) is True:
            self.pfc_class_3 = pfc_class_3
        else:
            raise TypeError('pfc_class_3 must be an instance of (list, type(None))')
        if isinstance(pfc_class_4, (list, type(None))) is True:
            self.pfc_class_4 = pfc_class_4
        else:
            raise TypeError('pfc_class_4 must be an instance of (list, type(None))')
        if isinstance(pfc_class_5, (list, type(None))) is True:
            self.pfc_class_5 = pfc_class_5
        else:
            raise TypeError('pfc_class_5 must be an instance of (list, type(None))')
        if isinstance(pfc_class_6, (list, type(None))) is True:
            self.pfc_class_6 = pfc_class_6
        else:
            raise TypeError('pfc_class_6 must be an instance of (list, type(None))')
        if isinstance(pfc_class_7, (list, type(None))) is True:
            self.pfc_class_7 = pfc_class_7
        else:
            raise TypeError('pfc_class_7 must be an instance of (list, type(None))')
