...
def supplement_paper_processing(ds, src_data, dest_data):
    ...
    # verify that flt_patients and fnl_asmts are compatible
    # -----------------------------------------------------
    print('patients')
    print(flt_ptnts.keys())
    p_ids_ = ds.get_reader(flt_ptnts['id'])[:]
...
if __name__ == '__main__':
    datastore = DataStore()
    src_file = '/home/ben/covid/ds_20200830_full.hdf5'
    dest_file = '/home/ben/covid/ds_20200830_supplements.hdf5'
