...
from hystore.core import exporter, persistence, utils, session, fields
from hystore.core.persistence import DataStore
from hystore.processing.nat_medicine_model import nature_medicine_model_1
from hystore.processing.method_paper_model import method_paper_model
...
if __name__ == '__main__':
    ...
    dest_file = '/home/ben/covid/ds_20200731_ppe.hdf5'
    with h5py.File(src_file, 'r') as src_data:
        with h5py.File(dest_file, 'w') as dest_data:
            ...
            ppe_use_and_travel(datastore, src_data, dest_data, start_timestamp)
