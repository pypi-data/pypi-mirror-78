...
class Boundary:
    @staticmethod
    def Apply_Dirichlet(engine, physical_group_id, M_full, C_full, K_full, f=None, g=None): #TODO: what do you expect for g(time and dof or only time)?
    ...
    @staticmethod
    def Impedance_Damping_Matrix(m3d, physical_group_id):
        ...
        :param physical_group_id: Physical group id(GMSH) of the impedance surface.
        :type physical_group_id: int
