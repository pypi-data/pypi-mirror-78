...
To install procin, run this command in your terminal:

.. code-block:: console

    $ pip install procin

This is the preferred method to install procin, as it will always install the most recent stable release.
...
The sources for procin can be downloaded from the `Github repo`_.
