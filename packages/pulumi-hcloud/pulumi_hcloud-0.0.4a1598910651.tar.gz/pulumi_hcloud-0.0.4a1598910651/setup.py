...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'hcloud', '0.0.4-alpha.1598910651+51fa1ba2'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource hcloud 0.0.4-alpha.1598910651+51fa1ba2`
                """)
            else:
                raise
