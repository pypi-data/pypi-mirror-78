...
[boto3.ServiceDiscovery 1.14.57](https://boto3.amazonaws.com/v1/documentation/api/1.14.57/reference/services/servicediscovery.html#ServiceDiscovery) service
compatible with
