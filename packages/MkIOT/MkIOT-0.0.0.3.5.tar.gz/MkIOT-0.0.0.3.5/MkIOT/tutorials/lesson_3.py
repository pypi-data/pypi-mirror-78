...
Discovery_Server = broadcast.Discovery_Server(
        ...
        "device_server"    # Discovery Data - What the hotphrase bearing connectors will get back
    )
...
for IP_ADDRESS in Discovery_Collector.Devices.All:
    ...
    if device.discovery_data == "device_server": # When you want a specific device, make it respond with something specific
        Server_Address = device.ip

if Server_Address == None:
    print("The device wasn't found")
else:
