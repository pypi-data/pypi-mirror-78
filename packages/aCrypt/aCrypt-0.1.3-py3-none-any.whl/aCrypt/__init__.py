...
def create_key():
    # generate key
    key = str(randint(0,99999999999999999999999999999999999999999999999999))
    key = [i for i in key]

    for i in range(9 - len(key)):
        key = [str(randint(1,9))] + key

    for i in range(len(key)):
        letter = key[i]
        if letter == "0":
            key[i] = str(randint(1,9))
...
def decipher(code,key):
    ...
    if str(code[0]) != "0" and str(code[0]) != "1":
