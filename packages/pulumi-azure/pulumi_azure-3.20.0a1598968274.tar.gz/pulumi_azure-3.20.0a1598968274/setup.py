...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.20.0-alpha.1598968274+0d5c9a01'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.20.0-alpha.1598968274+0d5c9a01`
                """)
            else:
                raise
