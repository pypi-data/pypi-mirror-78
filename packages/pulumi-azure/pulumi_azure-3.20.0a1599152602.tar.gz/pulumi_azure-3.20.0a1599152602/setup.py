...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.20.0-alpha.1599152602+e215e73f'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.20.0-alpha.1599152602+e215e73f`
                """)
            else:
                raise
