...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.20.0-alpha.1599239311+cf79ff1b'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.20.0-alpha.1599239311+cf79ff1b`
                """)
            else:
                raise
