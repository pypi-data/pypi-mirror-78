...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.20.0-alpha.1598889565+4d85840f'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.20.0-alpha.1598889565+4d85840f`
                """)
            else:
                raise
