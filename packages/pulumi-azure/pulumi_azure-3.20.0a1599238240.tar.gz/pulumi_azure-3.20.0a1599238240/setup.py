...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.20.0-alpha.1599238240+0fb294fb'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.20.0-alpha.1599238240+0fb294fb`
                """)
            else:
                raise
