...
class Plot(BaseObject):
    ...
    def color(self):
        ...
        """
        nplot = self.index()+1
        orgb = int(self.layer.GetNumProp(f'plot{nplot}.color'))
        return to_rgb(orgb)
    ...
    def color(self, rgb):
        ...
        """
        nplot = self.index()+1
        self.layer.SetNumProp(f'plot{nplot}.color', ocolor(rgb))
    def remove(self):
        """
        Deletes plot.
...
class GLayer(BaseLayer):
    ...
    def add_plot(self, obj, coly=-1, colx=-1, colz=-1, type = 's'):
        ...
        Parameters:
            ...
            type(str): 'l'(Line Plot) 's'(Scatter Plot)
        Returns:
        ...
        """
        if isinstance(obj, origin_class('DataRange')) or isinstance(obj, str):
    ...
    def add_mplot(self, ms, z, x=-1, y=-1, cm=-1, type=103):
        ...
        '''
        self.add_plot(ms, colz=z, type=type)
