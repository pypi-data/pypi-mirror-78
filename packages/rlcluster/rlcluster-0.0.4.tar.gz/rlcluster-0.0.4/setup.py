...
setup_args = {
    'name':             "rlcluster",
    'version':          verstr,
    'description':      "Implements Rodriguez-Laio clustering.",
    'long_description': "A Python library for data clustering by the approach described by Rodriguez and Laio (Science, 2014, 344, 1492-1495)",
    'author':           "Charlie Laughton",
    'author_email':     "charles.laughton@nottingham.ac.uk",
    'url':              "https://bitbucket.org/claughton/rlcluster",
    'license':          "BSD license.",
