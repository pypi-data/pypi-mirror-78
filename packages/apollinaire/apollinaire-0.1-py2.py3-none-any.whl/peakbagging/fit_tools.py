...
def plot_from_param (param_pkb, freq, psd, back=None, wdw=None, smoothing=50, spectro=True, correct_width=1.,
  ...
  ax3.plot (freq, quot_residuals, color='black') 
  ax3.plot (freq, smooth(quot_residuals, 20), color='green') 
  ax3.plot (freq, smooth(quot_residuals, 50), color='blue') 
  ax3.plot (freq, smooth(quot_residuals, 100), color='red') 
