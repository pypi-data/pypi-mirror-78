...
[boto3.ConnectParticipant 1.14.57](https://boto3.amazonaws.com/v1/documentation/api/1.14.57/reference/services/connectparticipant.html#ConnectParticipant) service
compatible with
