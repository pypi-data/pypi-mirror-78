...
[boto3.ConnectParticipant 1.14.56](https://boto3.amazonaws.com/v1/documentation/api/1.14.56/reference/services/connectparticipant.html#ConnectParticipant) service
compatible with
