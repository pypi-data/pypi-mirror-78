...
[boto3.MarketplaceCatalog 1.14.56](https://boto3.amazonaws.com/v1/documentation/api/1.14.56/reference/services/marketplace-catalog.html#MarketplaceCatalog) service
compatible with
