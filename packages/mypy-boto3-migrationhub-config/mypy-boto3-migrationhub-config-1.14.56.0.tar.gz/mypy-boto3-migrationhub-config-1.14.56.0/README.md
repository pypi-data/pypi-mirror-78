...
[boto3.MigrationHubConfig 1.14.56](https://boto3.amazonaws.com/v1/documentation/api/1.14.56/reference/services/migrationhub-config.html#MigrationHubConfig) service
compatible with
