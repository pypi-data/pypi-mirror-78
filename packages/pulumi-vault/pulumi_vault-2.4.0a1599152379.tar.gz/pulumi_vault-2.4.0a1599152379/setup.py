...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', '2.4.0-alpha.1599152379+a80c692c'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault 2.4.0-alpha.1599152379+a80c692c`
                """)
            else:
                raise
