...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'terraform', '3.1.0-alpha.1599065429+9a8b473d'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource terraform 3.1.0-alpha.1599065429+9a8b473d`
                """)
