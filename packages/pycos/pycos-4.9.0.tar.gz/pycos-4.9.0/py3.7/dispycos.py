...
class Client(object):
    ...
    def run_at(self, where, gen, *args, **kwargs):
        ...
        remote location.
        """
        return((yield self._run_request('run_async', where, 1, gen, *args, **kwargs)))

    def run(self, gen, *args, **kwargs):
        """Run CPU bound task at any remote server; see 'run_at'
        above.
        """
        return((yield self._run_request('run_async', None, 1, gen, *args, **kwargs)))
    ...
    def run_result_at(self, where, gen, *args, **kwargs):
        ...
        """
        return((yield self._run_request('run_result', where, 1, gen, *args, **kwargs)))
    ...
    def run_result(self, gen, *args, **kwargs):
        ...
        """
        return((yield self._run_request('run_result', None, 1, gen, *args, **kwargs)))
    ...
    def run_async_at(self, where, gen, *args, **kwargs):
        ...
        remote location.
        """
        return((yield self._run_request('run_async', where, 0, gen, *args, **kwargs)))

    def run_async(self, gen, *args, **kwargs):
        """Run I/O bound task at any server; see 'run_async_at'
        above.
        """
        return((yield self._run_request('run_async', None, 0, gen, *args, **kwargs)))
    ...
    def _run_request(self, request, where, cpu, gen, *args, **kwargs):
        ...
        return((yield Task(_run_req).finish()))
