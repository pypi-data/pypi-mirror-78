...
setup(
    name="transformational_measures_tf",
    version=VERSION,
    python_requires='>=3.6',
    ...
    author="Federico Ravettino, Facundo Manuel Quiroga",
    author_email="facundoq@gmail.com",
    description="Invariance, Same-Equivariance and other measures for Neural Networks. Support for TensorFlow.",
