...
def parse_to_python_object(string, from_CLI=True):
    ...
    def parse_array(string):
        ...
        while pos != -1:            
            ...
            result_arr.append(parse_to_python_object_v2(el.strip()))
        ...
        if values != '':
            result_arr.append(parse_to_python_object_v2(values))
    ...
    def parse_dict(string):
        ...
        while pos != -1:
            ...
            result_dict.update({k.strip().replace('"',''): parse_to_python_object_v2(v.strip())})
