...
def pairplot(
    ...
    def make_upper(r, w, no_x=True, no_y=True, **kwargs):
        ...
        chart = (
            ...
            .encode(
                alt.X(r, **enc_x_keywords),
                alt.Y(w, **enc_y_keywords),
                **color_kwarg,
            )
        )
    ...
    def make_diag(r, no_x=True, no_y=True, hist="simple", **kwargs):
        enc_x_keywords = {}
        enc_y_keywords = {}
