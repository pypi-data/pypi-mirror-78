...
[boto3.ServerlessApplicationRepository 1.14.53](https://boto3.amazonaws.com/v1/documentation/api/1.14.53/reference/services/serverlessrepo.html#ServerlessApplicationRepository) service
