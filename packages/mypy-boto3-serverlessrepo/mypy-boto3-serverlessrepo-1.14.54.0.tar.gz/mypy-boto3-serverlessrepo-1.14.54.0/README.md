...
[boto3.ServerlessApplicationRepository 1.14.54](https://boto3.amazonaws.com/v1/documentation/api/1.14.54/reference/services/serverlessrepo.html#ServerlessApplicationRepository) service
