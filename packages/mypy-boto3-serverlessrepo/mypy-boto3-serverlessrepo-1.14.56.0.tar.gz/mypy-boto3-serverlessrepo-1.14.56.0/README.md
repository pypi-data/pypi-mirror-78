...
[boto3.ServerlessApplicationRepository 1.14.56](https://boto3.amazonaws.com/v1/documentation/api/1.14.56/reference/services/serverlessrepo.html#ServerlessApplicationRepository) service
compatible with
