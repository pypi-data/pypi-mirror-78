...
class Client(object):
    ...
    def put_csv(self, absolute_path, data, encoding='utf-8', *args, **kwargs):
        if isinstance(data, pd.DataFrame):
            return self.put_pandas_csv(absolute_path, data, encoding='utf-8', *args, **kwargs)
        else:
            return self.put_csv_str(absolute_path, data, encoding='utf-8', *args, **kwargs)
    ...
    def put_json(self, absolute_path, data, encoding='utf-8'):
        if isinstance(data, pd.DataFrame):
            return self.put_pandas_json(absolute_path, data, encoding='utf-8')
        else:
            return self.put_json_str(absolute_path, data, encoding='utf-8')
    ...
    def put_pandas_json(self, absolute_path, data, encoding='utf-8'):
        data = data.to_json()
        self.put_json(self, absolute_path=absolute_path, data=data, encoding=encoding)
