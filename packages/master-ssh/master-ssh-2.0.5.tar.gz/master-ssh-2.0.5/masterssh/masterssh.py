            ...
            if cmd == "":
                ...
                if cmd.startswith('#'):
                    ...
                    if cmd == "#help" or cmd == "#":
                        ...
                        print('')
                        print('Examples:')
                        print('{param: <35}{help}'.format(param='#connect [host] [user] [password] [port] [name]', help='Connects to a new server. Port and name are optional!'))
                        ...
                        print("connect:[host],[username],[password],[name],[port] - Connects to a server. [name] is optional, but suggested")
                        """
