...
class TwoTerminalVoltageComponent(Component):
    ...
    """
    _branch: TwoTerminalBranch = field(init=False, repr=False)
    ...
    class TwoTerminalBranch(VoltageBranch):
        ...
        def update(self, i: float, coupled_v_i: np.ndarray, t1: float, t2: float):
            super().update(i, coupled_v_i, t1, t2)
            self.component.update(i, t1, t2)
    ...
    def update(self, i: float, t1: float, t2: float):
        """
