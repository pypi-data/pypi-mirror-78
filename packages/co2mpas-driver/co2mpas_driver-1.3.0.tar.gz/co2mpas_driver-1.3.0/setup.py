...
if __name__ == '__main__':
    ...
    setup(
        ...
        description='Co2mpas_driver implements the microsimulation '
                    'free-flow acceleration model (MFC), able to accurately '
                    'and consistently reproduce acceleration dynamics of light-duty vehicles',
