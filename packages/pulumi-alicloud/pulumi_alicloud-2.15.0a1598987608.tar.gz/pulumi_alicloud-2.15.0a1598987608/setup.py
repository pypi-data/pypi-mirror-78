...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', '2.15.0-alpha.1598987608+2d381ef0'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud 2.15.0-alpha.1598987608+2d381ef0`
                """)
            else:
                raise
