...
# source: tbreader/proto/tensor_shape.proto
...
_TENSORSHAPEPROTO_DIM = _descriptor.Descriptor(
  name='Dim',
  full_name='tbreader.TensorShapeProto.Dim',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='size', full_name='tbreader.TensorShapeProto.Dim.size', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='name', full_name='tbreader.TensorShapeProto.Dim.name', index=1,
...
_TENSORSHAPEPROTO = _descriptor.Descriptor(
  ...
  full_name='tbreader.TensorShapeProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='dim', full_name='tbreader.TensorShapeProto.dim', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='unknown_rank', full_name='tbreader.TensorShapeProto.unknown_rank', index=1,
...
TensorShapeProto = _reflection.GeneratedProtocolMessageType('TensorShapeProto', (_message.Message,), {
  ...
  'Dim' : _reflection.GeneratedProtocolMessageType('Dim', (_message.Message,), {
    ...
    '__module__' : 'tbreader.proto.tensor_shape_pb2'
    # @@protoc_insertion_point(class_scope:tbreader.TensorShapeProto.Dim)
    })
  ,
  'DESCRIPTOR' : _TENSORSHAPEPROTO,
  '__module__' : 'tbreader.proto.tensor_shape_pb2'
  # @@protoc_insertion_point(class_scope:tbreader.TensorShapeProto)
  })
