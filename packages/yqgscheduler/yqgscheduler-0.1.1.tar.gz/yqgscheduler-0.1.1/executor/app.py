...
class ExecutorApplication(object):
    """
    整合了zk, executor, zookeeper, yqg-scheduler, notifier
    """

    # TODO: configurations or inject
    def __init__(self, id, zk, executor, scheduler, notifier):
        ...
        self._logger = logging.getLogger("py-yqg-scheduler.app")
    ...
    def start(self):
        ...
        # watch yqg-scheduler master node
    ...
    def shutdown(self, timeout):
        ...
        self._zk.stop()
        self._executor.shutdown(timeout=30)
        self._notifier.shutdown(timeout=30)
